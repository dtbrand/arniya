...
$catalogProducts = [
    ...
    [
        ...
        'moq'             => 8,
        'image'           => '/Frontend/Wholesale/Asset/images/product2.png',
        'badge'           => 'New Catalogue',
        'badge_icon'      => '✨',
        'color'           => 'Crimson Rani',
    ...
    [
        ...
        'wholesale_price' => 989,
        'moq'             => 8,
        'image'           => '/Frontend/Wholesale/Asset/images/product5.png',
        'badge'           => 'New Arrival',
        'badge_icon'      => '🔥',
        'color'           => 'Teal Blue',
    ...
    [
        ...
        'moq'             => 8,
        'image'           => '/Frontend/Wholesale/Asset/images/product1.png',
        'badge'           => 'New Catalogue',
        'badge_icon'      => '💎',
        'color'           => 'Bottle Green',
    ...
    [
        ...
        'moq'             => 6,
        'image'           => '/Frontend/Wholesale/Asset/images/product3.png',
        'badge'           => 'New Arrival',
        'badge_icon'      => '👑',
        'color'           => 'Copper Gold',
    ...
    [
        ...
        'wholesale_price' => 249,
        'moq'             => 24,
        'image'           => '/Frontend/Wholesale/Asset/images/product7.png',
        'badge'           => 'Super Value',
        'badge_icon'      => '🚀',
        'color'           => 'Indigo Blue',
    ...
    [
        ...
        'wholesale_price' => 189,
        'moq'             => 30,
        'image'           => '/Frontend/Wholesale/Asset/images/product8.png',
        'badge'           => 'Fast Selling',
        'badge_icon'      => '⚡',
        'color'           => 'Ruby Red',
    ...
    [
        ...
        'wholesale_price' => 399,
        'moq'             => 18,
        'image'           => '/Frontend/Wholesale/Asset/images/product6.png',
        'badge'           => 'Best Margin',
        'badge_icon'      => '⚡',
        'color'           => 'Pastel Mint',
    ...
    [
        ...
        'wholesale_price' => 489,
        'moq'             => 16,
        'image'           => '/Frontend/Wholesale/Asset/images/product4.png',
        'badge'           => 'Trending',
        'badge_icon'      => '🔥',
        'color'           => 'Lavender Rose',
...
<link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@500;600;700;800;900&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Montserrat:wght@400;500;600;700&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="/Frontend/Wholesale/Asset/css/wholesale.css?v=1787019062">
...
<body>
    ...
    <header class="ws-header">
        ...
        <div class="ws-header-right">
            ...
            <div class="ws-user-profile-btn" onclick="switchWsTab('details')" title="Wholesaler Profile">
                <img src="/Frontend/Wholesale/Asset/images/profile.png" onerror="this.src='/Frontend/Wholesale/Asset/images/product1.png';" alt="User" class="ws-user-avatar-img" id="headerUserAvatar" loading="lazy" decoding="async">
        ...
        <aside class="ws-sidebar" id="wsSidebar">
            ...
            <div class="ws-sidebar-scroll">
                ...
                <div class="ws-side-user-card" onclick="switchWsTab('details'); toggleSidebar(false);" style="margin: 8px 8px 4px; padding: 7px 9px; background: linear-gradient(135deg, #FAF5E8 0%, #FFFFFF 100%); border: 1.2px solid rgba(212,175,55,0.35); border-radius: 9px; display: flex; align-items: center; gap: 8px; cursor: pointer; box-shadow: 0 2px 6px rgba(138,104,31,0.06);">
                    <img src="/Frontend/Wholesale/Asset/images/profile.png" onerror="this.src='/Frontend/Wholesale/Asset/images/product1.png';" alt="User" style="width: 28px; height: 28px; border-radius: 50%; border: 1.5px solid var(--ws-gold-primary); object-fit: cover; flex-shrink: 0;" loading="lazy" decoding="async">
    ...
    ═══════════════════════════════════════════ -->
    <script src="/Frontend/Wholesale/Asset/js/wholesale.js?v=1787019062"></script>
