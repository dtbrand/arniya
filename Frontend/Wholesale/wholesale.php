        ...
        <aside class="ws-sidebar" id="wsSidebar">
            <div class="ws-sidebar-brand-box">
                <a href="#" style="display:flex; align-items:center; text-decoration:none;">
                    <img src="/Shared/Asset/images/logo.png" onerror="this.src='/Frontend/Wholesale/Asset/images/logo.png';" alt="Kalaniketan" class="ws-brand-img-logo" style="height:36px; width:auto; max-width:150px; object-fit:contain;">
                </a>
