                ...
                <div class="dt-analytics-grid">
                    ...
                    <div class="dt-analytics-card">
                        <div class="dt-analytics-head">
                            ...
                            <a href="/Frontend/Admin/customers/segments.php" class="dt-btn dt-btn-pale dt-btn-sm" style="padding:2px 8px; font-size:0.7rem; text-decoration:none;">View Segments</a>
                        </div>
