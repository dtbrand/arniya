...
<head>
    ...
    <link rel="stylesheet" href="/Frontend/Admin/customers/assets/css/customer-segments.css?v=<?php echo time(); ?>">
</head>
<body>
...
<script src="/Frontend/Admin/customers/assets/js/customer-segments.js?v=<?php echo time(); ?>"></script>
</body>
</html>
