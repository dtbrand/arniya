            ...
            tr.innerHTML = `
                ...
                <td style="padding:12px 16px; text-align:right;">
                    <div style="display:inline-flex; align-items:center; gap:6px;">
                        <a href="/Frontend/Admin/customers/index.php" class="dt-btn dt-btn-pale dt-btn-sm" style="padding:3px 8px; font-size:0.72rem; text-decoration:none;">View Customers</a>
