<?php
/**
 * coupons.php - DT Brand's Admin Marketing Module
...
<head>
    ...
    <title>Marketing - Coupons - DT Brand's Admin</title>
        ...
        <main class="adm-content">
            <div class="adm-page-head">
                <div class="adm-page-title-group">
                    <h1 class="adm-page-title">
                        ...
                        <span class="adm-badge gold">MARKETING</span>
                    </h1>
                    <p class="adm-page-subtitle">Separate modular management for DT Brand's marketing.</p>
                </div>
            ...
            <div class="adm-card">
                <div class="adm-card-head">
                    <h3 class="adm-card-title"><span>Marketing - Coupons Suite</span></h3>
                ...
                <div style="padding:36px 20px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed #E5E1D7;">
                    ...
                    <h3 style="font-size:1.15rem; font-weight:800; color:#181512;">Marketing - Coupons</h3>
                    <p style="font-size:0.82rem; color:#7A7266; max-width:540px; margin:6px auto 18px;">
                        Dedicated modular view for <strong>Marketing</strong>. Ready to connect to MySQL backend and live CRM endpoints.
                    </p>
