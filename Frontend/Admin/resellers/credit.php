 ...
 * Reseller Credit Limit, Wallet & Working Capital Hub
 */
$page_title = "Reseller B2B Credit & Wallet Hub";
...
<head>
    ...
    <title>B2B Credit &amp; Wallet - DT Brand's Admin</title>
                ...
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px;">
                    <div>
                        <div style="display:flex; align-items:center; gap:8px;">
                            <h1 style="font-size:1.35rem; font-weight:900; color:#181512; margin:0;">Reseller B2B Credit &amp; Wallet Hub</h1>
                            <span class="dt-reseller-badge emerald">₹8.42L Total Outstanding</span>
                        </div>
                        <p style="font-size:0.78rem; color:#78716C; margin:3px 0 0 0;">Manage 30-day working capital lines, ledger records, bank settlements, and manual limit revisions.</p>
                    </div>
