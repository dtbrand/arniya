 ...
 * Reseller Commission & Payouts Hub
 */
$page_title = "Reseller Commissions & Payouts Hub";
                ...
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px;">
                    <div>
                        <div style="display:flex; align-items:center; gap:8px;">
                            <h1 style="font-size:1.35rem; font-weight:900; color:#181512; margin:0;">Commissions &amp; Payouts Settlement</h1>
                            <span class="dt-reseller-badge emerald">Weekly Payouts Active</span>
                        </div>
                        <p style="font-size:0.78rem; color:#78716C; margin:3px 0 0 0;">Manage affiliate bonuses, dropship incentives, and bank NEFT disbursement batches.</p>
                    </div>
