                    ...
                    <?php foreach ($partners as $p): ?>
                        <tr id="<?php echo $p['id']; ?>" class="partner-dir-row" data-cohort="<?php echo $p['cohort_id']; ?>" style="border-bottom:1px solid #F1ECE1;">
                            ...
                            <td class="partner-name-cell" style="font-weight:800; color:#181512; white-space:nowrap;">
                                <div>
                                    <a href="/Frontend/Admin/resellers/view.php?id=<?php echo $p['id']; ?>" style="color:#181512; text-decoration:none; font-weight:800;"><?php echo htmlspecialchars($p['name']); ?></a>
                            ...
                            <td style="text-align:right; white-space:nowrap;">
                                <div style="display:flex; justify-content:flex-end; gap:6px;">
                                    ...
                                    <a href="/Frontend/Admin/resellers/view.php?id=<?php echo $p['id']; ?>" class="dt-btn dt-btn-info dt-btn-sm">
                                        <span>Manage</span>
                                    </a>
                                </div>
                            </td>
