...
<head>
    ...
    <link rel="stylesheet" href="/Frontend/Admin/resellers/assets/css/reseller-segments.css?v=<?php echo time(); ?>">
...
<script src="/Frontend/Admin/resellers/assets/js/reseller-segments.js?v=<?php echo time(); ?>"></script>
</body>
</html>
