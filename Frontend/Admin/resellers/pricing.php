                ...
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px;">
                    <div>
                        <div style="display:flex; align-items:center; gap:8px;">
                            <h1 style="font-size:1.35rem; font-weight:900; color:#181512; margin:0;">Tiered Pricing &amp; Partner Margins</h1>
                            <span class="dt-reseller-badge gold">4 Active Tier Levels</span>
                        </div>
                        <p style="font-size:0.78rem; color:#78716C; margin:3px 0 0 0;">Manage discount structures (10% to 30% OFF), MOQ rules, and monthly volume commitments.</p>
                    </div>
