<?php
/**
 * activity-logs.php - DT Brand's Admin Users Module
...
<head>
    ...
    <title>Users - Activity Logs - DT Brand's Admin</title>
        ...
        <main class="adm-content">
            ...
            <div class="adm-card">
                <div class="adm-card-head">
                    <h3 class="adm-card-title"><span>Users - Activity Logs Suite</span></h3>
                ...
                <div style="padding:36px 20px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed #E5E1D7;">
                    ...
                    <h3 style="font-size:1.15rem; font-weight:800; color:#181512;">Users - Activity Logs</h3>
