...
<div style="display:flex; flex-direction:column; gap:12px;">
    ...
    <div class="dt-wholesale-kpi-grid">
        ...
        <a href="/Frontend/Admin/wholesale/index.php" class="dt-wholesale-kpi-card">
        ...
        <!-- 2. Active Accounts -->
        <a href="/Frontend/Admin/wholesale/approved.php" class="dt-wholesale-kpi-card">
            <div class="dt-wholesale-kpi-top">
        ...
        <a href="/Frontend/Admin/wholesale/pending.php" class="dt-wholesale-kpi-card">
            <div class="dt-wholesale-kpi-top">
        ...
        <!-- 4. Wholesale Orders -->
        <a href="/Frontend/Admin/wholesale/orders.php" class="dt-wholesale-kpi-card">
            <div class="dt-wholesale-kpi-top">
        ...
        <a href="/Frontend/Admin/wholesale/credit.php" class="dt-wholesale-kpi-card">
            <div class="dt-wholesale-kpi-top">
        ...
        <a href="/Frontend/Admin/wholesale/suspended.php" class="dt-wholesale-kpi-card">
            <div class="dt-wholesale-kpi-top">
        ...
        <a href="/Frontend/Admin/wholesale/tiers.php" class="dt-wholesale-kpi-card" style="background:linear-gradient(135deg, #181512 0%, #2A241E 100%); border-color:#8A681F; color:#FFFFFF;">
            <div class="dt-wholesale-kpi-top">
    ...
    <div style="display:flex; align-items:center; gap:8px; overflow-x:auto; padding:4px 0;">
        <a href="/Frontend/Admin/wholesale/index.php" class="dt-status-pill-clean gold" style="text-decoration:none;">All Wholesalers 124</a>
        <a href="/Frontend/Admin/wholesale/approved.php" class="dt-status-pill-clean emerald" style="text-decoration:none;">Active Verified 98</a>
        <a href="/Frontend/Admin/wholesale/pending.php" class="dt-status-pill-clean amber" style="text-decoration:none;">Pending Applications 14</a>
        <a href="/Frontend/Admin/wholesale/tiers.php" class="dt-status-pill-clean gold" style="text-decoration:none;">Platinum Tier (35%) 28</a>
        <a href="/Frontend/Admin/wholesale/credit.php" class="dt-status-pill-clean blue" style="text-decoration:none;">With Credit Line 64</a>
        <a href="/Frontend/Admin/wholesale/suspended.php" class="dt-status-pill-clean crimson" style="text-decoration:none;">Suspended 6</a>
        <a href="/Frontend/Admin/wholesale/rejected.php" class="dt-status-pill-clean crimson" style="text-decoration:none;">Rejected 10</a>
    </div>
</div>
