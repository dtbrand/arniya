            ...
            <div class="dt-orders-container">
                ...
                <div class="dt-refund-toolbar">
                    <div class="dt-refund-toolbar-left">
                        ...
                        <input type="text" id="refundSearchInput" oninput="window.DT_REFUNDS.handleSearch(this.value)" placeholder="Search Refund ID, Order ID, Customer, UTR..." class="dt-order-search-input" style="height:36px; padding-left:32px; width:100%; border-radius:6px; box-sizing:border-box;">
