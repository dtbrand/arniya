...
// Status Counts Model
$status_pills = [
    ['key' => 'all', 'label' => 'All Orders', 'count' => (string)$statusCounts['all'], 'url' => '/Frontend/Admin/orders/index.php', 'icon' => '<rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect>'],
    ['key' => 'pending', 'label' => 'Pending', 'count' => (string)$statusCounts['pending'], 'url' => '/Frontend/Admin/orders/pending.php', 'icon' => '<circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline>'],
    ['key' => 'confirmed', 'label' => 'Confirmed', 'count' => (string)$statusCounts['confirmed'], 'url' => '/Frontend/Admin/orders/confirmed.php', 'icon' => '<path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline>'],
    ['key' => 'processing', 'label' => 'Processing', 'count' => (string)$statusCounts['processing'], 'url' => '/Frontend/Admin/orders/processing.php', 'icon' => '<polyline points="23 4 23 10 17 10"></polyline><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path>'],
    ['key' => 'packed', 'label' => 'Packed', 'count' => (string)$statusCounts['packed'], 'url' => '/Frontend/Admin/orders/packed.php', 'icon' => '<polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline>'],
    ['key' => 'shipped', 'label' => 'In Transit / Shipped', 'count' => (string)$statusCounts['shipped'], 'url' => '/Frontend/Admin/orders/shipped.php', 'icon' => '<rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle>'],
    ['key' => 'out_for_delivery', 'label' => 'Out For Delivery', 'count' => (string)$statusCounts['out_for_delivery'], 'url' => '/Frontend/Admin/orders/out-for-delivery.php', 'icon' => '<circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 14 14"></polyline>'],
    ['key' => 'delivered', 'label' => 'Delivered', 'count' => (string)$statusCounts['delivered'], 'url' => '/Frontend/Admin/orders/delivered.php', 'icon' => '<path d="M20 6L9 17l-5-5"></path>'],
    ['key' => 'cancelled', 'label' => 'Cancelled', 'count' => (string)$statusCounts['cancelled'], 'url' => '/Frontend/Admin/orders/cancelled.php', 'icon' => '<circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line>'],
    ['key' => 'failed', 'label' => 'Failed', 'count' => (string)$statusCounts['failed'], 'url' => '/Frontend/Admin/orders/failed.php', 'icon' => '<circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line>'],
    ['key' => 'returned', 'label' => 'RMA Returns', 'count' => (string)$statusCounts['returned'], 'url' => '/Frontend/Admin/orders/returned.php', 'icon' => '<polyline points="1 4 1 10 7 10"></polyline><path d="M3.51 15a9 9 0 1 0 2.13-9.36L1 10"></path>'],
    ['key' => 'refunded', 'label' => 'Refunds Ledger', 'count' => (string)$statusCounts['refunded'], 'url' => '/Frontend/Admin/orders/refunded.php', 'icon' => '<path d="M6 3h12M6 8h12M6 13l8.5 8M6 13h3a4 4 0 0 0 0-8"></path>']
];
?>
