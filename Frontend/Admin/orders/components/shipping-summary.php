...
<div class="dt-detail-card">
    ...
    <div class="dt-detail-card-body" style="font-size:11.5px; display:flex; flex-direction:column; gap:8px;">
        ...
        <div style="display:flex; gap:6px; margin-top:4px;">
            <a href="/Frontend/Admin/orders/shipping-label.php?id=<?php echo htmlspecialchars($order['id'] ?? 'DTB-001624'); ?>" class="dt-btn dt-btn-pale" style="flex:1; height:28px; font-size:11px;">
                <span>Print Label</span>
            </a>
            <a href="/Frontend/Admin/orders/packing-slip.php?id=<?php echo htmlspecialchars($order['id'] ?? 'DTB-001624'); ?>" class="dt-btn dt-btn-pale" style="flex:1; height:28px; font-size:11px;">
