<?php
/**
 * processing.php — Processing Orders Filtered View
 * DT Brand's & Jai Hanuman Tex
 */
$page_title = "Processing Orders";
$active_nav = "orders";
$active_subnav = "processing";
$active_status_key = "processing";
                ...
                <div class="dt-orders-head">
                    <div class="dt-orders-title-group">
                        <h1 class="dt-orders-title">
                            ...
                            <span class="dt-status-badge processing"><span class="dt-status-dot"></span><span>24 Processing</span></span>
                        </h1>
