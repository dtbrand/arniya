                ...
                <div style="display:flex; align-items:center; gap:12px;">
                    ...
                    <div>
                        ...
                        <div style="font-size:11.5px; color:#64748b; margin-top:2px;">
                            Parent Category: <a href="/Frontend/Admin/catalogue/categories/view.php?id=<?php echo $subcat['parent_id']; ?>" style="color:#8A681F; font-weight:700; text-decoration:none;"><?php echo htmlspecialchars($subcat['parent']); ?></a> • 
