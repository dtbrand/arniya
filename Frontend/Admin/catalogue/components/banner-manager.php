...
<div class="dt-cat-card">
    <div class="dt-cat-card-header">
        ...
        <div style="display:flex; gap:6px; align-items:center;">
            <a href="/Frontend/Admin/catalogue/banners/reorder.php" class="dt-btn-action-sm pale-gold" style="height:28px; padding:0 10px; font-size:11px; text-decoration:none;">Reorder Banners</a>
            <a href="/Frontend/Admin/catalogue/banners/add.php" class="dt-btn-action-sm gold" style="height:28px; padding:0 12px; font-size:11px; text-decoration:none;">+ Add Banner</a>
        </div>
    </div>
        ...
        <div class="dt-banner-grid">
            ...
            <div class="dt-banner-card">
                ...
                <div class="dt-banner-content">
                    ...
                    <div style="display:flex; gap:6px; margin-top:10px;">
                        <a href="/Frontend/Admin/catalogue/banners/edit.php?id=1" class="dt-btn-action-sm pale-gold" style="flex:1; height:26px; font-size:11px; justify-content:center; text-decoration:none;">
            ...
            <div class="dt-banner-card">
                ...
                <div class="dt-banner-content">
                    ...
                    <div style="display:flex; gap:6px; margin-top:10px;">
                        <a href="/Frontend/Admin/catalogue/banners/edit.php?id=2" class="dt-btn-action-sm pale-gold" style="flex:1; height:26px; font-size:11px; justify-content:center; text-decoration:none;">
                            <svg viewBox="0 0 24 24" width="11" height="11" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                            <span>Edit Banner</span>
                        </a>
                        <button type="button" class="dt-btn-action-sm danger" onclick="this.closest('.dt-banner-card').remove(); if(window.DT_CATALOGUE) window.DT_CATALOGUE.showToast('Banner deleted successfully!');" style="height:26px; padding:0 8px; font-size:11px;">
