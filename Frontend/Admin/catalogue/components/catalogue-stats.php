...
<div class="dt-cat-kpi-grid">
    ...
    <a href="/Frontend/Admin/catalogue/categories/" class="dt-cat-kpi-card">
    ...
    <a href="/Frontend/Admin/catalogue/subcategories/" class="dt-cat-kpi-card">
    ...
    <a href="/Frontend/Admin/catalogue/collections/" class="dt-cat-kpi-card">
    ...
    <a href="/Frontend/Admin/products/" class="dt-cat-kpi-card">
        <div class="dt-cat-kpi-icon" style="background:#FAF5E8; border:1px solid #D4AF37; color:#8A681F;">
