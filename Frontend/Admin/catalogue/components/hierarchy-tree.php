        ...
        <li class="dt-tree-node" id="node-sarees">
            <div class="dt-tree-item level-0">
                <div style="display:flex; align-items:center; gap:10px;">
                    ...
                    <div>
                        <a href="/Frontend/Admin/catalogue/categories/view.php?id=1" style="color:#181512; text-decoration:none; font-size:12.5px; font-weight:700;">Silk Sarees &amp; Handlooms</a>
                ...
                <li class="dt-tree-node" id="node-kanjivaram">
                    <div class="dt-tree-item level-1">
                        ...
                        <div style="display:flex; align-items:center; gap:6px;">
                            ...
                            <a href="/Frontend/Admin/catalogue/subcategories/edit.php?id=101" class="dt-btn-action-sm pale-gold" style="height:22px; padding:0 6px; font-size:10.5px;">Edit</a>
                        </div>
                    </div>
                </li>
                <li class="dt-tree-node" id="node-banarasi">
                    <div class="dt-tree-item level-1">
                        ...
                        <div style="display:flex; align-items:center; gap:6px;">
                            ...
                            <a href="/Frontend/Admin/catalogue/subcategories/edit.php?id=102" class="dt-btn-action-sm pale-gold" style="height:22px; padding:0 6px; font-size:10.5px;">Edit</a>
                        </div>
                    </div>
                </li>
                <li class="dt-tree-node" id="node-chanderi">
                    <div class="dt-tree-item level-1">
                        ...
                        <div style="display:flex; align-items:center; gap:6px;">
                            ...
                            <a href="/Frontend/Admin/catalogue/subcategories/edit.php?id=103" class="dt-btn-action-sm pale-gold" style="height:22px; padding:0 6px; font-size:10.5px;">Edit</a>
                        </div>
                    </div>
                </li>
            </ul>
        ...
        <li class="dt-tree-node" id="node-lehengas" style="margin-top:10px;">
            <div class="dt-tree-item level-0">
                <div style="display:flex; align-items:center; gap:10px;">
                    ...
                    <div>
                        <a href="/Frontend/Admin/catalogue/categories/view.php?id=2" style="color:#181512; text-decoration:none; font-size:12.5px; font-weight:700;">Bridal &amp; Festive Lehengas</a>
                        <span class="dt-badge gold" style="font-size:9.5px; margin-left:6px;">Featured</span>
                    </div>
                </div>
                <div style="display:flex; align-items:center; gap:8px;">
        ...
        <li class="dt-tree-node" id="node-kurtis" style="margin-top:10px;">
            <div class="dt-tree-item level-0">
                <div style="display:flex; align-items:center; gap:10px;">
                    ...
                    <div>
                        <a href="/Frontend/Admin/catalogue/categories/view.php?id=3" style="color:#181512; text-decoration:none; font-size:12.5px; font-weight:700;">Designer Kurtis &amp; Tunics</a>
                    </div>
                </div>
                <div style="display:flex; align-items:center; gap:8px;">
