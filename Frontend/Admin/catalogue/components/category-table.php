...
<div class="dt-cat-card">
    <div class="dt-cat-card-header">
        ...
        <div style="display:flex; gap:6px; align-items:center;">
            <a href="/Frontend/Admin/catalogue/categories/add.php" class="dt-btn-action-sm gold" style="height:28px; padding:0 12px; font-size:11px;">
            ...
            <a href="/Frontend/Admin/catalogue/categories/reorder.php" class="dt-btn-action-sm pale-gold" style="height:28px; padding:0 10px; font-size:11px;">
        ...
        <table class="dt-cat-table" id="catListTable">
            ...
            <tbody>
                ...
                <tr id="cat-row-1" data-status="active">
                    ...
                    <td>
                        <a href="/Frontend/Admin/catalogue/categories/view.php?id=1" style="font-weight:700; color:#181512; text-decoration:none; font-size:12.5px;">Silk Sarees</a>
                    ...
                    <td style="text-align:right;">
                        <div style="display:inline-flex; gap:4px;">
                            <a href="/Frontend/Admin/catalogue/categories/view.php?id=1" class="dt-btn-action-sm pale-gold" style="height:24px; padding:0 8px; font-size:11px;">View</a>
                ...
                <tr id="cat-row-2" data-status="active">
                    ...
                    <td>
                        <a href="/Frontend/Admin/catalogue/categories/view.php?id=2" style="font-weight:700; color:#181512; text-decoration:none; font-size:12.5px;">Bridal Lehengas</a>
                    ...
                    <td style="text-align:right;">
                        <div style="display:inline-flex; gap:4px;">
                            <a href="/Frontend/Admin/catalogue/categories/view.php?id=2" class="dt-btn-action-sm pale-gold" style="height:24px; padding:0 8px; font-size:11px;">View</a>
                ...
                <tr id="cat-row-3" data-status="active">
                    ...
                    <td>
                        <a href="/Frontend/Admin/catalogue/categories/view.php?id=3" style="font-weight:700; color:#181512; text-decoration:none; font-size:12.5px;">Designer Kurtis</a>
                    ...
                    <td style="text-align:right;">
                        <div style="display:inline-flex; gap:4px;">
                            <a href="/Frontend/Admin/catalogue/categories/view.php?id=3" class="dt-btn-action-sm pale-gold" style="height:24px; padding:0 8px; font-size:11px;">View</a>
                ...
                <tr id="cat-row-4" data-status="active">
                    ...
                    <td>
                        <a href="/Frontend/Admin/catalogue/categories/view.php?id=4" style="font-weight:700; color:#181512; text-decoration:none; font-size:12.5px;">Dress Materials</a>
                    ...
                    <td style="text-align:right;">
                        <div style="display:inline-flex; gap:4px;">
                            <a href="/Frontend/Admin/catalogue/categories/view.php?id=4" class="dt-btn-action-sm pale-gold" style="height:24px; padding:0 8px; font-size:11px;">View</a>
                            <a href="/Frontend/Admin/catalogue/categories/edit.php?id=4" class="dt-btn-action-sm pale-gold" style="height:24px; padding:0 8px; font-size:11px;">Edit</a>
