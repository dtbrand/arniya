        ...
        <main class="adm-content" style="padding: 14px 18px; width: 100%; max-width: 100%; box-sizing: border-box;">
            ...
            <div class="wp-heading-wrap" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px; margin-bottom:14px;">
                <div>
                    ...
                    <p style="font-size:12px; color:#64748b; margin:2px 0 0 0;">Upload desktop &amp; mobile hero banners, set destination targets and schedules.</p>
                </div>
            </div>

            <form onsubmit="if(window.DT_CATALOGUE) window.DT_CATALOGUE.showToast('✅ Banner saved live!'); return false;" class="dt-form-grid">
                <div>
                    <div class="dt-form-card">
                        ...
                        <div class="dt-form-group">
                            ...
                            <input type="text" class="dt-form-input" required placeholder="e.g. Surat Heritage Silk Festival">
                        </div>
                        <div class="dt-form-group">
                            <label class="dt-form-label">Target Link URL</label>
                            <input type="text" class="dt-form-input" placeholder="e.g. /shop/silk-sarees">
                        </div>
                        <div class="dt-form-group">
                            <label class="dt-form-label">CTA Button Text</label>
                            <input type="text" class="dt-form-input" placeholder="e.g. Explore Wholesale Lot">
                        </div>
                    </div>
                    ...
                    <div class="dt-form-card">
                        ...
                        <div class="dt-form-group">
                            ...
                            <div class="dt-upload-zone" onclick="document.getElementById('bDeskUp').click()">
                                ...
                                <span style="font-size:11px; font-weight:700; color:#8A681F;">Click to Select Desktop Banner</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="dt-form-card">
                        ...
                        <div class="dt-form-group">
                            ...
                            <select class="dt-form-select">
                                <option>Homepage Main Hero</option>
                                <option>Category Top Header</option>
                                <option>Mid-Page Promotional Ribbon</option>
                            </select>
                        </div>
                        <div style="display:flex; flex-direction:column; gap:8px; margin-top:14px;">
                            <button type="submit" class="dt-btn-action-sm gold" style="height:34px; justify-content:center; font-size:12px;">Save Banner</button>
