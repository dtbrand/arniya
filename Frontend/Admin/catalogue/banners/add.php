<?php
/**
 * banners/add.php — Add Banner with Multi-Size & Mobile Engine
...
<head>
    ...
    <title>Add Banner ‹ DT Brand's Catalogue</title>
    ...
    <link rel="stylesheet" href="/Frontend/Admin/catalogue/assets/css/banners.css?v=<?php echo time(); ?>">
</head>
<body>
    ...
    <div class="adm-main">
        ...
        <main class="adm-content" style="padding: 14px 18px; width: 100%; max-width: 100%; box-sizing: border-box;">
            ...
            <div class="wp-heading-wrap" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px; margin-bottom:14px;">
                <div>
                    <h1 class="wp-heading-inline" style="font-size:20px; font-weight:800; color:#181512; margin:0;">Add New Banner</h1>
                    <p style="font-size:12px; color:#64748b; margin:2px 0 0 0;">Configure responsive multi-size banners for desktop screens and mobile smartphones.</p>
                </div>
                <div style="display:flex; gap:6px;">
                    <a href="/Frontend/Admin/catalogue/banners/" class="dt-btn-action-sm pale-gold" style="height:30px; padding:0 12px; font-size:11.5px; text-decoration:none;">Back to Banners</a>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="dt-form-card">
                        ...
                        <div class="dt-form-group">
                            ...
                            <input type="text" id="bannerTitle" class="dt-form-input" required placeholder="e.g. Surat Heritage Silk Festival 2026">
                        </div>

                        <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
                            <div class="dt-form-group">
                                <label class="dt-form-label" for="bannerSubtitle">Sub-Heading / Tagline</label>
                                <input type="text" id="bannerSubtitle" class="dt-form-input" placeholder="e.g. Direct Surat Factory Wholesale Rates • Certified Silk Mark">
                            </div>
                            <div class="dt-form-group">
                                <label class="dt-form-label" for="bannerCta">Call to Action (CTA) Button</label>
                                <input type="text" id="bannerCta" class="dt-form-input" placeholder="e.g. Explore Wholesale Catalogues">
                            </div>
                        </div>

                        <div class="dt-form-group">
                            <label class="dt-form-label" for="bannerLink">Destination Target URL</label>
                            <input type="text" id="bannerLink" class="dt-form-input" placeholder="e.g. /shop/silk-sarees or /collection/surat-heritage-silk">
                        </div>
                    </div>
                            ...
                            <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px; margin-bottom:8px;">
                                <div class="dt-form-group" style="margin-bottom:0;">
                                    ...
                                    <select class="dt-form-select" id="deskRatioSelect" onchange="window.DT_CATALOGUE.updateBannerRatio('desk', this.value)">
                                        <option value="16-5" selected>1920 × 600 px (16:5 — Wide Hero Slider)</option>
                                        <option value="4-1">1920 × 450 px (4:1 — Category Top Strip)</option>
                                        <option value="12-5">1200 × 500 px (12:5 — Content Section)</option>
                                        <option value="1-1">1080 × 1080 px (1:1 — Square Grid Card)</option>
                                    </select>
                                </div>
                                <div class="dt-form-group" style="margin-bottom:0;">
                ...
                <div>
                    ...
                    <div class="dt-form-card">
                        ...
                        <div class="dt-form-group">
                            ...
                            <select class="dt-form-select">
                                <option selected>Homepage Main Top Hero Slider</option>
                                <option>Category Page Header Banner</option>
                                <option>Collection Spotlight Banner</option>
                        ...
                        <div class="dt-form-group">
                            ...
                            <select class="dt-form-select">
                                <option selected>All Devices (Responsive Auto-Switch)</option>
                                <option>Desktop &amp; Tablet Only</option>
                                <option>Mobile Only (Smartphones)</option>
                            </select>
                        </div>

                        <div class="dt-form-group">
                            <label class="dt-form-label">Sort Priority Order</label>
                            <input type="number" class="dt-form-input" value="1" min="1" max="99">
                        </div>
