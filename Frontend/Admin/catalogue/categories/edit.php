...
$category_data = [
    ...
    'image' => ($cat_id === 2 ? '/Frontend/Shop/Asset/images/product6.png' : ($cat_id === 3 ? '/Frontend/Shop/Asset/images/product4.png' : '/Frontend/Shop/Asset/images/product1.png')),
    ...
    <div class="adm-main">
        ...
        <main class="adm-content" style="padding: 14px 18px; width: 100%; max-width: 100%; box-sizing: border-box;">
            ...
            <div class="wp-heading-wrap" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px; margin-bottom:14px;">
                ...
                <a href="/Frontend/Admin/catalogue/categories/view.php?id=<?php echo $cat_id; ?>" class="dt-btn-action-sm pale-gold" style="height:30px; padding:0 12px; font-size:11.5px;">View Live Page</a>
            </div>
