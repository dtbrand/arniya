...
<nav class="adm-mobile-bottom-dock" id="admMobileBottomDock">
    ...
    <a href="/Frontend/Admin/products/" class="adm-dock-item <?php echo $curr_nav === 'products' ? 'active' : ''; ?>" onclick="if(typeof switchAdmTab==='function' && document.getElementById('tab-products')){ switchAdmTab('products'); return false; }" title="Products">
    ...
    <!-- Tab 4: WhatsApp CRM -->
    <a href="/Frontend/Admin/whatsapp/" class="adm-dock-item <?php echo $curr_nav === 'whatsapp' ? 'active' : ''; ?>" onclick="if(typeof switchAdmTab==='function' && document.getElementById('tab-whatsapp')){ switchAdmTab('whatsapp'); return false; }" title="WhatsApp CRM">
    ...
    <!-- Tab 5: Orders Hub -->
    <a href="/Frontend/Admin/orders/" class="adm-dock-item <?php echo $curr_nav === 'orders' ? 'active' : ''; ?>" onclick="if(typeof switchAdmTab==='function' && document.getElementById('tab-orders')){ switchAdmTab('orders'); return false; }" title="Orders">
