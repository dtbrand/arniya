<?php
/**
 * adminsidebar.php — Luxury Dark & Gold Branded Admin Sidebar
...
<aside class="adm-sidebar" id="admSidebar">
    ...
    <div class="adm-sidebar-scroll">
        ...
        <div class="adm-sidebar-user">
            <img src="/Shared/Asset/images/profile.png" onerror="this.src='/Frontend/Shop/Asset/images/product1.png';" alt="Super Admin" class="adm-sidebar-user-avatar">
            <div class="adm-sidebar-user-info">
                <div class="adm-sidebar-user-name">Gautam Sethi</div>
                <div class="adm-sidebar-user-role">Super Admin</div>
            </div>
        </div>

        <!-- Group 1: OVERVIEW -->
        <div class="adm-nav-group">
            <div class="adm-nav-heading">Main Overview</div>
            <ul class="adm-nav-list">
                <li>
                    <a class="adm-nav-item active" id="navItem-overview" onclick="switchAdmTab('overview')">
                        ...
                        <span class="adm-nav-label">Dashboard Overview</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="adm-nav-group">
            <div class="adm-nav-heading">Catalog & Orders</div>
            <ul class="adm-nav-list">
                <li>
                    <a class="adm-nav-item" id="navItem-products" onclick="switchAdmTab('products')">
                        ...
                        <span class="adm-nav-label">Products & Catalog</span>
                ...
                <li>
                    <a class="adm-nav-item" id="navItem-orders" onclick="switchAdmTab('orders')">
                        ...
                        <span class="adm-nav-label">Orders & Shipments</span>
                        <span class="adm-nav-badge gold">5 New</span>
                    </a>
                </li>
            </ul>
        </div>

        <!-- Group 3: WHATSAPP CRM -->
        <div class="adm-nav-group">
            <div class="adm-nav-heading">WhatsApp CRM</div>
            <ul class="adm-nav-list">
                <li>
                    <a class="adm-nav-item" id="navItem-whatsapp" onclick="switchAdmTab('whatsapp')">
                        ...
                        <span class="adm-nav-label">CRM & Broadcasts</span>
        ...
        <!-- Group 4: PARTNERS & CUSTOMERS -->
        <div class="adm-nav-group">
            <div class="adm-nav-heading">Network & Users</div>
            <ul class="adm-nav-list">
                <li>
                    <a class="adm-nav-item" id="navItem-partners" onclick="switchAdmTab('partners')">
                        ...
                        <span class="adm-nav-label">Wholesalers & Resellers</span>
                    </a>
                </li>
                <li>
                    <a class="adm-nav-item" id="navItem-customers" onclick="switchAdmTab('customers')">
                        ...
                        <span class="adm-nav-label">Customer CRM Directory</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="adm-nav-group">
            <div class="adm-nav-heading">Finance & System</div>
            <ul class="adm-nav-list">
                <li>
                    <a class="adm-nav-item" id="navItem-reports" onclick="switchAdmTab('reports')">
                        ...
                        <span class="adm-nav-label">Sales & GST Reports</span>
                    </a>
                </li>
                <li>
    ...
    <!-- Sidebar Bottom Portal Shortcuts & Sign Out -->
    <div class="adm-sidebar-footer">
        <a href="/Frontend/Shop/shop.php" target="_blank" class="adm-portal-switch">
            <span>🛍️ View B2C Shop</span>
        ...
        <a href="/Frontend/Wholesale/wholesale.php" target="_blank" class="adm-portal-switch">
            <span>📦 Wholesale Portal</span>
            <svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="2" fill="none"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
        </a>
        <a href="/Frontend/Admin/adminlogin.php?action=logout" class="adm-portal-switch" style="background:rgba(185,28,28,0.12); border-color:rgba(185,28,28,0.25); color:#EF4444;" title="Sign Out of Admin Portal">
            <span>🚪 Sign Out</span>
