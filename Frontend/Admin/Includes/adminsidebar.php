    ...
    <div class="adm-sidebar-scroll">
        ...
        <div class="adm-nav-group">
            ...
            <ul class="adm-nav-list">
                <li>
                    <a class="adm-nav-item active" id="navItem-overview" onclick="switchAdmTab('overview')" data-title="Dashboard">
                ...
                <li>
                    <a class="adm-nav-item" id="navItem-orders" onclick="switchAdmTab('orders')" data-title="Orders & Shipments">
                ...
                <li>
                    <a class="adm-nav-item" id="navItem-products" onclick="switchAdmTab('products')" data-title="Products Catalog">
                ...
                <li>
                    <a class="adm-nav-item" id="navItem-reports" onclick="switchAdmTab('reports')" data-title="Sales & GST Reports">
                ...
                <li>
                    <a class="adm-nav-item" id="navItem-whatsapp" onclick="switchAdmTab('whatsapp')" data-title="WhatsApp CRM">
                ...
                <li>
                    <a class="adm-nav-item" id="navItem-partners" onclick="switchAdmTab('partners')" data-title="Partners Network">
                ...
                <li>
                    <a class="adm-nav-item" id="navItem-customers" onclick="switchAdmTab('customers')" data-title="Customers CRM">
        ...
        <div class="adm-nav-group">
            ...
            <ul class="adm-nav-list">
                <li>
                    <a class="adm-nav-item" id="navItem-settings" onclick="switchAdmTab('settings')" data-title="Store Settings">
