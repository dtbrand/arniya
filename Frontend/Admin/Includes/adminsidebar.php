            ...
            <ul class="adm-nav-list">
                ...
                <li class="adm-nav-has-sub <?php echo $current_nav === 'wholesalers' ? 'open' : ''; ?>">
                    ...
                    <ul class="adm-nav-submenu <?php echo $current_nav === 'wholesalers' ? 'open' : ''; ?>" id="admSubmenu-wholesalers">
                        ...
                        <li>
                            <a href="/admin/wholesale/pending.php" class="adm-nav-subitem <?php echo ($current_nav === 'wholesalers' && $current_subnav === 'pending') ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/wholesale/approved.php" class="adm-nav-subitem <?php echo ($current_nav === 'wholesalers' && $current_subnav === 'approved') ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/wholesale/pricing.php" class="adm-nav-subitem <?php echo ($current_nav === 'wholesalers' && $current_subnav === 'pricing') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M6 3h12M6 8h12M6 13l8.5 8M6 13h3a4 4 0 0 0 0-8"></path></svg>
                                <span>Pricing &amp; Margins</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/wholesale/tiers.php" class="adm-nav-subitem <?php echo ($current_nav === 'wholesalers' && $current_subnav === 'tiers') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                                <span>Tiers &amp; MOQ</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/wholesale/credit.php" class="adm-nav-subitem <?php echo ($current_nav === 'wholesalers' && $current_subnav === 'credit') ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/wholesale/orders.php" class="adm-nav-subitem <?php echo ($current_nav === 'wholesalers' && $current_subnav === 'orders') ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/wholesale/segments.php" class="adm-nav-subitem <?php echo ($current_nav === 'wholesalers' && $current_subnav === 'segments') ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/wholesale/analytics.php" class="adm-nav-subitem <?php echo ($current_nav === 'wholesalers' && $current_subnav === 'analytics') ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/wholesale/export.php" class="adm-nav-subitem <?php echo ($current_nav === 'wholesalers' && $current_subnav === 'export') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                                <span>Export Studio</span>
                            </a>
                        </li>
                ...
                <li class="adm-nav-has-sub <?php echo $current_nav === 'resellers' ? 'open' : ''; ?>">
                    ...
                    <ul class="adm-nav-submenu <?php echo $current_nav === 'resellers' ? 'open' : ''; ?>" id="admSubmenu-resellers">
                        <li>
                            <a href="/admin/resellers/" class="adm-nav-subitem <?php echo ($current_nav === 'resellers' && $current_subnav === 'all') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                                <span>All Resellers</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/resellers/pending.php" class="adm-nav-subitem <?php echo $current_subnav === 'pending' ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 14 14"></polyline></svg>
                                <span>Pending Applications</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/resellers/approved.php" class="adm-nav-subitem <?php echo $current_subnav === 'approved' ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                                <span>Approved Partners</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/resellers/verification.php" class="adm-nav-subitem <?php echo $current_subnav === 'verification' ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/resellers/documents.php" class="adm-nav-subitem <?php echo $current_subnav === 'documents' ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/resellers/pricing.php" class="adm-nav-subitem <?php echo $current_subnav === 'pricing' ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M6 3h12M6 8h12M6 13l8.5 8M6 13h3a4 4 0 0 0 0-8"></path></svg>
                                <span>Tiered Pricing &amp; MOQ</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/resellers/credit.php" class="adm-nav-subitem <?php echo $current_subnav === 'credit' ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>
                                <span>Credit &amp; Wallet Hub</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/resellers/commissions.php" class="adm-nav-subitem <?php echo $current_subnav === 'commissions' ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 14 14"></polyline></svg>
                                <span>Commissions &amp; Payouts</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/resellers/segments.php" class="adm-nav-subitem <?php echo $current_subnav === 'segments' ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                                <span>Segments &amp; Cohorts</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/resellers/analytics.php" class="adm-nav-subitem <?php echo $current_subnav === 'analytics' ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                                <span>Analytics &amp; GMV</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/resellers/export.php" class="adm-nav-subitem <?php echo $current_subnav === 'export' ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                                <span>Export Studio</span>
                            </a>
                        </li>
                ...
                <!-- RETAIL MANAGEMENT WITH REAL SVG SUBMENU -->
                <li class="adm-nav-has-sub <?php echo $current_nav === 'retail' ? 'open' : ''; ?>">
                    <a href="/admin/retail/" class="adm-nav-item <?php echo $current_nav === 'retail' ? 'active' : ''; ?>" id="navItem-retail" data-title="Retail Management">
                        <svg class="adm-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg>
                        <span class="adm-nav-label">Retail Management</span>
                        <span class="adm-nav-badge gold">D2C Hub</span>
                        <span class="adm-nav-arrow-wrap" onclick="event.preventDefault(); event.stopPropagation(); toggleSidebarSubmenu(this);" title="Toggle submenu">
                            <svg class="adm-nav-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="9 18 15 12 9 6"></polyline></svg>
                        </span>
                    </a>
                    <ul class="adm-nav-submenu <?php echo $current_nav === 'retail' ? 'open' : ''; ?>" id="admSubmenu-retail">
                        <li>
                            <a href="/admin/retail/" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && ($current_subnav === 'dashboard' || empty($current_subnav))) ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                                <span>Overview Hub</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/customers.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'customers') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle></svg>
                                <span>Retail Customers</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/orders.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'orders') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"></line><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path></svg>
                                <span>Retail Orders</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/sales.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'sales') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>
                                <span>Sales Analysis</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/revenue.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'revenue') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M6 3h12M6 8h12M6 13l8.5 8M6 13h3a4 4 0 0 0 0-8"></path></svg>
                                <span>Net Revenue Studio</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/pricing.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'pricing') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>
                                <span>Pricing &amp; Margins</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/discounts.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'discounts') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="9" y1="9" x2="15" y2="15"></line></svg>
                                <span>Discounts &amp; Coupons</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/catalogue.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'catalogue') ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/retail/cart.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'cart') ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/retail/abandoned-carts.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'abandoned-carts') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line></svg>
                                <span>Abandoned Carts</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/checkout.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'checkout') ? 'active' : ''; ?>">
                        ...
                        <li>
                            <a href="/admin/retail/segments.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'segments') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><circle cx="12" cy="12" r="10"></circle><path d="M12 2a10 10 0 0 1 10 10"></path></svg>
                                <span>Customer Segments</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/activity.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'activity') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 14 14"></polyline></svg>
                                <span>Activity Stream</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/reviews.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'reviews') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                                <span>Ratings &amp; Reviews</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/wishlist.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'wishlist') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                                <span>Wishlist Demand</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/analytics.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'analytics') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                                <span>Growth Analytics</span>
                            </a>
                        </li>
                        <li>
                            <a href="/admin/retail/export.php" class="adm-nav-subitem <?php echo ($current_nav === 'retail' && $current_subnav === 'export') ? 'active' : ''; ?>">
                                <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                                <span>Export Studio</span>
                            </a>
                        </li>
