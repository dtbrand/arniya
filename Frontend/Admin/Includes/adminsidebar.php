    ...
    <div class="adm-sidebar-scroll">
        ...
        <div class="adm-nav-group">
            ...
            <ul class="adm-nav-list">
                <li>
                    <a href="/Frontend/Admin/admin.php" class="adm-nav-item <?php echo $current_nav === 'dashboard' ? 'active' : ''; ?>" id="navItem-overview" onclick="if(typeof switchAdmTab==='function') { switchAdmTab('overview'); return false; }" data-title="Dashboard">
                ...
                <li>
                    <a href="/Frontend/Admin/whatsapp/" class="adm-nav-item <?php echo $current_nav === 'whatsapp' ? 'active' : ''; ?>" id="navItem-whatsapp" onclick="if(typeof switchAdmTab==='function') { switchAdmTab('whatsapp'); return false; }" data-title="WhatsApp CRM">
        ...
        <div class="adm-nav-group">
            ...
            <ul class="adm-nav-list">
                <li>
                    <a href="/Frontend/Admin/products/" class="adm-nav-item <?php echo $current_nav === 'products' ? 'active' : ''; ?>" id="navItem-products" onclick="if(typeof switchAdmTab==='function') { switchAdmTab('products'); return false; }" data-title="Products Catalog">
                ...
                <li>
                    <a href="/Frontend/Admin/orders/" class="adm-nav-item <?php echo $current_nav === 'orders' ? 'active' : ''; ?>" id="navItem-orders" onclick="if(typeof switchAdmTab==='function') { switchAdmTab('orders'); return false; }" data-title="Orders & Shipments">
                ...
                <li>
                    <a href="/Frontend/Admin/pricing/" class="adm-nav-item <?php echo $current_nav === 'pricing' ? 'active' : ''; ?>" data-title="Multi-Tier Pricing">
                ...
                <li>
                    <a href="/Frontend/Admin/reviews/" class="adm-nav-item <?php echo $current_nav === 'reviews' ? 'active' : ''; ?>" data-title="Customer Reviews">
        ...
        <div class="adm-nav-group">
            ...
            <ul class="adm-nav-list">
                <li>
                    <a href="/Frontend/Admin/wholesalers/" class="adm-nav-item <?php echo $current_nav === 'wholesalers' ? 'active' : ''; ?>" data-title="Wholesale B2B Hub">
                ...
                <li>
                    <a href="/Frontend/Admin/resellers/" class="adm-nav-item <?php echo $current_nav === 'resellers' ? 'active' : ''; ?>" data-title="Resellers Network">
                ...
                <li>
                    <a href="/Frontend/Admin/retailers/" class="adm-nav-item <?php echo $current_nav === 'retailers' ? 'active' : ''; ?>" data-title="Retailer Accounts">
                ...
                <li>
                    <a href="/Frontend/Admin/customers/" class="adm-nav-item <?php echo $current_nav === 'customers' ? 'active' : ''; ?>" id="navItem-customers" onclick="if(typeof switchAdmTab==='function') { switchAdmTab('customers'); return false; }" data-title="Customers Directory">
        ...
        <div class="adm-nav-group">
            ...
            <ul class="adm-nav-list">
                <li>
                    <a href="/Frontend/Admin/inventory/" class="adm-nav-item <?php echo $current_nav === 'inventory' ? 'active' : ''; ?>" data-title="Warehouse Inventory">
                ...
                <li>
                    <a href="/Frontend/Admin/shipping/" class="adm-nav-item <?php echo $current_nav === 'shipping' ? 'active' : ''; ?>" data-title="Shipping & Courier">
                ...
                <li>
                    <a href="/Frontend/Admin/payments/" class="adm-nav-item <?php echo $current_nav === 'payments' ? 'active' : ''; ?>" data-title="Payments & Gateway">
        ...
        <div class="adm-nav-group">
            ...
            <ul class="adm-nav-list">
                <li>
                    <a href="/Frontend/Admin/marketing/" class="adm-nav-item <?php echo $current_nav === 'marketing' ? 'active' : ''; ?>" data-title="Marketing & Campaigns">
                ...
                <li>
                    <a href="/Frontend/Admin/cms/" class="adm-nav-item <?php echo $current_nav === 'cms' ? 'active' : ''; ?>" data-title="CMS Pages">
                ...
                <li>
                    <a href="/Frontend/Admin/media/" class="adm-nav-item <?php echo $current_nav === 'media' ? 'active' : ''; ?>" data-title="Media Library">
                ...
                <li>
                    <a href="/Frontend/Admin/notifications/" class="adm-nav-item <?php echo $current_nav === 'notifications' ? 'active' : ''; ?>" data-title="Notifications Hub">
        ...
        <div class="adm-nav-group">
            ...
            <ul class="adm-nav-list">
                <li>
                    <a href="/Frontend/Admin/reports/" class="adm-nav-item <?php echo $current_nav === 'reports' ? 'active' : ''; ?>" id="navItem-reports" onclick="if(typeof switchAdmTab==='function') { switchAdmTab('reports'); return false; }" data-title="Sales & GST Reports">
                ...
                <li>
                    <a href="/Frontend/Admin/users/" class="adm-nav-item <?php echo $current_nav === 'users' ? 'active' : ''; ?>" data-title="Admin Users & Roles">
                ...
                <li>
                    <a href="/Frontend/Admin/settings/" class="adm-nav-item <?php echo $current_nav === 'settings' ? 'active' : ''; ?>" id="navItem-settings" onclick="if(typeof switchAdmTab==='function') { switchAdmTab('settings'); return false; }" data-title="Store Settings">
                ...
                <li>
                    <a href="/Frontend/Admin/system/" class="adm-nav-item <?php echo $current_nav === 'system' ? 'active' : ''; ?>" data-title="System Health & API">
