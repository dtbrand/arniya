...
<head>
    ...
    <link rel="stylesheet" href="/Frontend/Admin/retail/assets/css/retail-dashboard.css?v=<?php echo time(); ?>">
            ...
            <div class="dt-retail-container">
                ...
                <div class="dt-retail-head">
                    ...
                    <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
                        <a href="/Frontend/Admin/retail/customers.php" class="dt-btn dt-btn-pale">
                        ...
                        <a href="/Frontend/Admin/retail/orders.php" class="dt-btn dt-btn-pale">
                        ...
                        <a href="/Frontend/Admin/retail/export.php" class="dt-btn dt-btn-gold">
...
<script src="/Frontend/Admin/retail/assets/js/retail-orders.js?v=<?php echo time(); ?>"></script>
<script src="/Frontend/Admin/retail/assets/js/retail-cart.js?v=<?php echo time(); ?>"></script>
