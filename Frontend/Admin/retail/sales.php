...
<head>
    ...
    <link rel="stylesheet" href="/Frontend/Admin/retail/assets/css/retail-sales.css?v=<?php echo time(); ?>">
            ...
            <div class="dt-retail-container">
                <div class="dt-retail-head">
                    ...
                    <div style="display:flex; align-items:center; gap:8px;">
                        <a href="/Frontend/Admin/retail/revenue.php" class="dt-btn dt-btn-pale">
