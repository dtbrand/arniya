...
<head>
    ...
    <link rel="stylesheet" href="/Frontend/Admin/retail/assets/css/retail-cart.css?v=<?php echo time(); ?>">
</head>
<body>
        ...
        <main class="adm-content" style="padding: 18px 20px; width: 100%; max-width: 100%; box-sizing: border-box;">
            ...
            <div class="dt-retail-container">
                <div class="dt-retail-head">
                    ...
                    <a href="/Frontend/Admin/retail/abandoned-carts.php" class="dt-btn dt-btn-gold">
