...
<head>
    ...
    <link rel="stylesheet" href="/Frontend/Admin/retail/assets/css/retail-discounts.css?v=<?php echo time(); ?>">
</head>
<body>
...
<script src="/Frontend/Admin/retail/assets/js/retail-discounts.js?v=<?php echo time(); ?>"></script>
</body>
</html>
