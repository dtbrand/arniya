...
<div class="dt-retail-card">
    <div class="dt-retail-card-head">
        ...
        <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
            ...
            <a href="/Frontend/Admin/customers/" class="dt-btn dt-btn-pale dt-btn-sm">Full Customers Module →</a>
        </div>
    </div>
...
<div id="dtRetailCustomerModal" class="dt-modal-backdrop">
    <div class="dt-modal-dialog">
        ...
        <div class="dt-modal-foot">
            ...
            <a href="/Frontend/Admin/customers/" class="dt-btn dt-btn-gold">Open Full Customer Dossier</a>
        </div>
    </div>
</div>
