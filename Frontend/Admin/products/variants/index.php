        ...
        <main class="adm-content" style="padding: 16px 20px;">
            ...
            <div class="wp-heading-wrap" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px; margin-bottom:14px;">
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
                    ...
                    <a href="/Frontend/Admin/products/attributes/" class="wp-button" style="height:32px; padding:0 12px; display:inline-flex; align-items:center; gap:5px; font-size:12px; font-weight:700; text-decoration:none; background:#EFF6FF; border:1px solid #93C5FD; color:#1D4ED8;">
                    ...
                    <tbody id="variantsTableBody">
                        ...
                        <tr style="border-bottom:1px solid #f0f0f1; transition:background 0.15s;" onmouseover="this.style.background='#FDFBF7'" onmouseout="this.style.background='transparent'">
                            ...
                            <td style="padding:10px 12px;">
                                <a href="/Frontend/Admin/products/edit.php?id=<?php echo $v['parent_id']; ?>" style="font-size:13px; font-weight:700; color:#181512; text-decoration:none;">
                            ...
                            <td style="padding:10px 12px; text-align:right;">
                                <a href="/Frontend/Admin/products/edit.php?id=<?php echo $v['parent_id']; ?>#variations" class="wp-button" style="height:26px; font-size:11px; padding:0 8px; background:#FAF5E8; border:1px solid #D4AF37; color:#8A681F; font-weight:700; text-decoration:none;">
                                    Edit Variant
                                </a>
                            </td>
                        </tr>
