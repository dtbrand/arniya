<?php
/**
 * index.php — DT Brand's New Arrivals (Wholesale Desktop & WooCommerce Hybrid)
        ...
        <main class="adm-content" style="padding: 16px 20px;">
            ...
            <div class="wp-heading-wrap" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px; margin-bottom:14px;">
                <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
                    <h1 class="wp-heading-inline" style="font-size:22px; font-weight:800; color:#181512; margin:0;">New Arrivals</h1>
                    <span class="adm-badge gold" style="font-weight:700; font-size:11px; padding:3px 8px;">★ Fresh Surat Weaves</span>
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(200px, 1fr)); gap:12px; margin-bottom:14px;">
                <div class="dt-kpi-card">
                    ...
                    <div>
                        <div style="font-size:11px; color:#646970; font-weight:600;">FRESH WEAVING RELEASES</div>
                        <div style="font-size:17px; font-weight:800; color:#181512;">64 SKUs</div>
                    </div>
                </div>
            ...
            <div class="wp-tablenav" style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px; margin-bottom:12px;">
                ...
                <div class="wp-search-box" style="display:flex; align-items:center; gap:6px;">
                    <div style="position:relative; display:inline-flex; align-items:center;">
                        ...
                        <input type="text" id="wpSearchInput" class="wp-search-input" placeholder="Search new arrivals..." style="height:32px; padding-left:36px; padding-right:28px; width:220px; font-size:12px; border:1px solid #c3c4c7; border-radius:4px; outline:none;" oninput="searchWpProducts(this.value); toggleSearchClearBtn(this.value)">
            ...
            <div id="productGridView" class="dt-ws-grid" style="display:none;">
                <div class="dt-ws-card">
                    <div style="position:relative;">
                        ...
                        <span class="adm-badge" style="position:absolute; top:8px; left:8px; background:#8A681F; color:#fff; font-weight:700; font-size:10px;">★ Fresh Surat Weaves</span>
                ...
                <div class="dt-ws-card">
                    <div style="position:relative;">
                        ...
                        <span class="adm-badge" style="position:absolute; top:8px; left:8px; background:#D4AF37; color:#181512; font-weight:800; font-size:10px;">★ Fresh Surat Weaves</span>
...
window.shareProductWhatsApp = function(id) {
    const text = encodeURIComponent(`Hello DT Brand's! Inquiring about New Arrivals ID: #${id}. https://jaihanumantex.in/Frontend/Admin/products/view.php?id=${id}`);
