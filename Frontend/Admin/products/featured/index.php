<?php
/**
 * index.php — DT Brand's Featured Products (Wholesale Desktop & WooCommerce Hybrid)
 * DT Brand's & Jai Hanuman Tex
 */
$page_title = "Featured Products";
$active_nav = "products";
$active_subnav = "featured-products";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(200px, 1fr)); gap:12px; margin-bottom:14px;">
                <div class="dt-kpi-card">
                    ...
                    <div>
                        ...
                        <div style="font-size:17px; font-weight:800; color:#181512;">48 SKUs</div>
                    </div>
                </div>
            ...
            <div class="wp-tablenav" style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px; margin-bottom:12px;">
                ...
                <div class="wp-search-box" style="display:flex; align-items:center; gap:6px;">
                    <div style="position:relative; display:inline-flex; align-items:center;">
                        ...
                        <input type="text" id="wpSearchInput" class="wp-search-input" placeholder="Search featured products..." style="height:32px; padding-left:36px; padding-right:28px; width:220px; font-size:12px; border:1px solid #c3c4c7; border-radius:4px; outline:none;" oninput="searchWpProducts(this.value); toggleSearchClearBtn(this.value)">
            ...
            <div id="productGridView" class="dt-ws-grid" style="display:none;">
                <div class="dt-ws-card">
                    <div style="position:relative;">
                        ...
                        <span class="adm-badge" style="position:absolute; top:8px; left:8px; background:#8A681F; color:#fff; font-weight:700; font-size:10px;">★ Featured Collection</span>
                ...
                <div class="dt-ws-card">
                    <div style="position:relative;">
                        ...
                        <span class="adm-badge" style="position:absolute; top:8px; left:8px; background:#D4AF37; color:#181512; font-weight:800; font-size:10px;">★ Featured Collection</span>
...
window.shareProductWhatsApp = function(id) {
    const text = encodeURIComponent(`Hello DT Brand's! Inquiring about Featured Products ID: #${id}. https://jaihanumantex.in/Frontend/Admin/products/view.php?id=${id}`);
