        ...
        <main class="adm-content" style="padding: 16px 20px;">
            ...
            <div class="wp-heading-wrap" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px; margin-bottom:14px;">
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
                    ...
                    <a href="/Frontend/Admin/products/variants/" class="wp-button" style="height:32px; padding:0 12px; display:inline-flex; align-items:center; gap:5px; font-size:12px; font-weight:700; text-decoration:none; background:#EFF6FF; border:1px solid #93C5FD; color:#1D4ED8;">
            ...
            <div class="wp-tablenav" style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px; margin-bottom:12px;">
                ...
                <div class="wp-search-box" style="display:flex; align-items:center; gap:6px;">
                    ...
                    <button type="button" class="wp-button primary" onclick="searchAttributes(document.getElementById('attrSearchInput').value)" style="height:34px; font-size:12px; font-weight:800; padding:0 14px; background:linear-gradient(135deg, #8A681F 0%, #B8860B 50%, #D4AF37 100%); color:#181512; border:1px solid #8A681F;">Search</button>
                </div>
            </div>
    ...
    <div style="background:#fff; width:95%; max-width:520px; border-radius:10px; box-shadow:0 25px 50px -12px rgba(0,0,0,0.4); overflow:hidden; border:2px solid #D4AF37;">
        <div style="background:linear-gradient(135deg, #181512 0%, #2A241E 50%, #3D342A 100%); padding:14px 18px; color:#FAF5E8; display:flex; align-items:center; justify-content:space-between; border-bottom:2px solid #D4AF37;">
            <div style="display:flex; align-items:center; gap:8px;">
                ...
                <h3 style="margin:0; font-size:15px; font-weight:800; color:#FAF5E8;">Add New Textile Attribute</h3>
            </div>
            <button type="button" onclick="closeAddAttributeModal()" style="background:none; border:none; color:#FAF5E8; font-size:22px; cursor:pointer; line-height:1;">&times;</button>
        </div>
        ...
        <div style="background:#f6f7f7; padding:12px 18px; border-top:1px solid #e2e8f0; display:flex; justify-content:flex-end; gap:10px;">
            ...
            <button type="button" class="wp-button primary" onclick="submitNewAttribute()" style="height:32px; font-size:12px; font-weight:800; background:linear-gradient(135deg, #8A681F 0%, #B8860B 50%, #D4AF37 100%); color:#181512; border:1px solid #8A681F;">+ Save Attribute</button>
        </div>
    </div>
</div>
