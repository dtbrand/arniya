...
<div class="dt-form-section">
    <div class="dt-form-sec-head"><h3 class="dt-form-sec-title"><span>🏭 Warehouse Stock Allocation</span></h3></div>
    <div class="dt-form-sec-body">
        <div class="adm-form-grid">
            ...
            <div class="adm-form-group">
                <label class="adm-form-label">Low Stock Threshold Alert</label>
