...
<div class="dt-form-section">
    <div class="dt-form-sec-head">
        <h3 class="dt-form-sec-title"><span>🎨 Attributes &amp; Variant Matrix</span></h3>
        <button type="button" class="adm-btn-secondary adm-btn-sm" onclick="if(typeof generateVariantMatrix==='function') generateVariantMatrix();">+ Generate Variants</button>
    </div>
    <div class="dt-form-sec-body">
        <div class="dt-variant-generator-box">
            <div style="font-weight:700; font-size:0.82rem; margin-bottom:8px;">Active Attributes:</div>
            <div>
                ...
                <span class="dt-attr-chip">Fabric: Pure Mulberry Silk ✕</span>
            </div>
        </div>
