...
<link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@500;600;700;800;900&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Montserrat:wght@400;500;600;700&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="/Frontend/Reseller/Asset/css/reseller.css?v=1787017812">
...
<body>
    ...
    <header class="ws-header">
        ...
        <div class="ws-header-right">
            <!-- Wishlist Button -->
            <button class="ws-hdr-icon-btn" id="headerWishlistBtn" title="Reseller Wishlist" onclick="if(typeof window.openWishlistDrawer==='function') window.openWishlistDrawer(); else window.location.href='wishlist.php';" aria-label="Reseller Wishlist">
                <svg viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                <span class="ws-hdr-badge" id="headerWishlistBadge" style="display:none;">0</span>
            </button>

            <!-- Cart Button -->
            <button class="ws-hdr-icon-btn" id="headerCartBtn" title="Reseller Cart" onclick="if(typeof window.openCartDrawer==='function') window.openCartDrawer(); else window.location.href='cart.php';" aria-label="Reseller Cart">
    ...
    ═══════════════════════════════════════════ -->
    <script src="/Frontend/Reseller/Asset/js/reseller.js?v=1787017812"></script>
