...
$catalogProducts = [
    ...
    [
        ...
        'wholesale_price' => 249,
        'moq'             => 24,
        'image'           => '/Frontend/Reseller/Asset/images/product7.png',
        'badge'           => 'Super Value',
        'badge_icon'      => '🚀',
        'color'           => 'Indigo Blue',
    ...
    [
        ...
        'wholesale_price' => 189,
        'moq'             => 30,
        'image'           => '/Frontend/Reseller/Asset/images/product8.png',
        'badge'           => 'Fast Selling',
        'badge_icon'      => '⚡',
        'color'           => 'Ruby Red',
...
<body>
                            ...
                            <article class="product-card" data-product-id="<?= $prod['id'] ?>" role="listitem">
                                <div class="card-image-wrap">
                                    <a href="/Frontend/Single-Product/singleproduct.php?id=<?= $prod['id'] ?>" style="display:block;width:100%;height:100%;">
                                        <img src="<?= htmlspecialchars($prod['image']) ?>" alt="<?= htmlspecialchars($prod['name']) ?>" class="card-img" onerror="this.src='/Frontend/Reseller/Asset/images/product1.png';" loading="lazy">
                                    </a>
    ...
    ═══════════════════════════════════════════ -->
    <script src="/Frontend/Reseller/Asset/js/reseller.js?v=1787019062"></script>
