...
<header class="pdp-header" id="pdpHeader">
    ...
    <div class="pdp-header-main">
        ...
        <div class="pdp-header-actions">
            ...
            <a href="javascript:void(0)" onclick="if(typeof window.openAccountModal==='function'){window.openAccountModal('profile');}else{window.location.href='../../Shared/Auth/myaccount.php';}" class="pdp-account-btn" id="pdpAccountBtn" aria-label="My Account">
