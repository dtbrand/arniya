...
<link href="https://fonts.googleapis.com/css2?family=Cinzel:wght@500;600;700;800;900&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Montserrat:wght@400;500;600;700&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="/Frontend/Retailer/Asset/css/retailer.css?v=1787015531">
...
<body>
    ...
    <header class="ws-header">
        ...
        <div class="ws-header-right">
            <!-- Wishlist Button -->
            <button class="ws-hdr-icon-btn" id="headerWishlistBtn" title="Retail Wishlist" onclick="if(typeof window.openWishlistDrawer==='function') window.openWishlistDrawer(); else window.location.href='wishlist.php';" aria-label="Retail Wishlist">
                <svg viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                <span class="ws-hdr-badge" id="headerWishlistBadge" style="display:none;">0</span>
            </button>

            <!-- Cart Button -->
            <button class="ws-hdr-icon-btn" id="headerCartBtn" title="Retail Cart" onclick="if(typeof window.openCartDrawer==='function') window.openCartDrawer(); else window.location.href='cart.php';" aria-label="Retail Cart">
        ...
        <aside class="ws-sidebar" id="wsSidebar">
            <div class="ws-sidebar-brand-box">
                <a href="#" style="display:flex; align-items:center; text-decoration:none;">
                    <img src="/Shared/Asset/images/logo.png" onerror="this.src='/Frontend/Retailer/Asset/images/logo.png';" alt="Kalaniketan" class="ws-brand-img-logo" style="height:36px; width:auto; max-width:150px; object-fit:contain;">
                </a>
                ...
                <div class="ws-invoice-sheet">
                    <div class="ws-inv-header">
                        <div class="ws-inv-brand">
                            ...
                            <p><strong>Kalaniketan Retail Procurement & Logistics Ledger</strong><br>
    ...
    ═══════════════════════════════════════════ -->
    <script src="/Frontend/Retailer/Asset/js/retailer.js?v=1787015531"></script>
