        ...
        <div class="header-actions">
            ...
            <div class="header-account-wrap" id="headerAccountWrap">
                ...
                <div class="header-account-dropdown" id="headerAccountDropdown">
                    <a href="../../Shared/Auth/myaccount.php" class="ac-drop-item" id="acDropMyAccount">
                    ...
                    <a href="../../Shared/Auth/myaccount.php?tab=login" class="ac-drop-item" id="acDropLogin">
                    ...
                    <a href="../../Shared/Auth/myaccount.php?tab=register" class="ac-drop-item" id="acDropRegister">
                    ...
                    <a href="../../Shared/Auth/myaccount.php?tab=forgot" class="ac-drop-item" id="acDropForgot">
