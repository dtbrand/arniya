<?php
/**
 * shop.php — UPGRADED ETHNIC STOREFRONT HOME PAGE
 * Premium Meesho-Style E-Commerce, Reseller & Wholesale Shopping Experience
...
<script src="/Frontend/Shop/Asset/js/shop.js?v=<?php echo time(); ?>"></script>
