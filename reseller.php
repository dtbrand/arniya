...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ── Reseller Filter Pills Design System ── */
        ...
        /* ════════════════════════════════════════════════════════════
           RESELLER CRM & CUSTOMER MANAGEMENT SUITE STYLING
        ════════════════════════════════════════════════════════════ */
        .ws-hdr-search-box {
            position: relative;
            flex: 1;
        ...
        .crm-tag-vip { background: #FEF3C7; color: #B45309; border: 1px solid #FDE68A; }
        .crm-tag-repeat { background: #DCFCE7; color: #15803D; border: 1px solid #BBF7D0; }
        .crm-tag-new { background: #E0E7FF; color: #4338CA; border: 1px solid #C7D2FE; }
        .crm-tag-highvalue { background: #FCE7F3; color: #BE185D; border: 1px solid #FBCFE8; }
        .crm-tag-inactive { background: #F3F4F6; color: #6B7280; border: 1px solid #E5E7EB; }
        .crm-tag-followup { background: #FFF7ED; color: #C2410C; border: 1px solid #FFEDD5; }
        .crm-tag-regular { background: #F0FDF4; color: #166534; border: 1px solid #DCFCE7; }
        ...
        .crm-avatar-lg {
            ...
            height: 56px;
            border-radius: 50%;
            background: linear-gradient(135deg, #8A681F 0%, #B45309 100%);
            color: #FFFFFF;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .crm-floating-quick-order-btn {
            ...
            color: #FFFFFF;
            border: 2px solid #FFFFFF;
            box-shadow: 0 6px 20px rgba(138, 104, 31, 0.45);
            display: flex;
            align-items: center;
            justify-content: center;
            font-size: 1.5rem;
        ...
        .crm-floating-quick-order-btn:hover {
            transform: scale(1.08);
        }
...
/* ═════════════════════════════════════════════════════════════════════
   RESELLER CRM, CUSTOMERS, PROFIT & OPERATIONS LUXURY CSS SUITE
═════════════════════════════════════════════════════════════════════ */
...
.ws-filter-pill.active {
    background: linear-gradient(135deg, #8A681F 0%, #D4AF37 100%) !important;
    color: #FFFFFF !important;
...
/* ── Left-Aligned Search Input (Search Bar Placement Rule) ── */
.ws-luxury-search-wrap {
    position: relative;
    display: inline-flex;
    align-items: center;
...
.crm-kpi-icon {
    ...
    height: 42px;
    border-radius: 12px;
    background: linear-gradient(135deg, #FAF4E6 0%, #F3E7C9 100%);
...
.crm-bulk-bar {
    ...
    align-items: center;
    justify-content: space-between;
    background: linear-gradient(135deg, #1E1B18 0%, #352D24 100%);
    color: #FFFFFF;
    border-radius: 12px;
    padding: 10px 16px;
    margin-bottom: 14px;
...
/* ── Table Action Buttons & Cell Enhancements ── */
...
/* ── Luxury Modals & Quick Order Drawer ── */
.crm-modal-luxury {
    background: #FFFFFF;
    border-radius: 18px;
...
.crm-modal-luxury .ws-modal-header {
    background: linear-gradient(135deg, #FEFBF4 0%, #FAF5E8 100%);
    border-bottom: 1.5px solid #EBDDBD;
    padding: 16px 20px;
    display: flex;
    align-items: center;
    justify-content: space-between;
...
.crm-modal-luxury .ws-modal-header h3 {
    font-family: var(--ws-font-serif);
    font-size: 1.15rem;
    font-weight: 900;
    color: #8A681F;
