...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/home.css?v=<?= @filemtime(__DIR__ . '/assets/css/home.css') ?: '3.2.1' ?>">
    <link rel="stylesheet" href="/assets/css/policies.css?v=<?= @filemtime(__DIR__ . '/assets/css/policies.css') ?: '3.2.1' ?>">
</head>
<body>
