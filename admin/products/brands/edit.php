        ...
        <main class="adm-content" style="padding: 16px 20px;">
            ...
            <div class="wp-heading-wrap" style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px; margin-bottom:16px;">
                ...
                <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
                    ...
                    <a href="/shop?brand=<?php echo urlencode($cur_brand['name']); ?>" target="_blank" class="wp-button" style="height:32px; padding:0 12px; display:inline-flex; align-items:center; gap:5px; font-size:12px; font-weight:700; text-decoration:none; background:#EFF6FF; border:1px solid #93C5FD; color:#1D4ED8;">
                    ...
                    <div>
                        ...
                        <div class="dt-card">
                            ...
                            <div class="dt-card-body">
                                ...
                                <button type="button" class="wp-button dt-btn-crimson" style="width:100%; height:30px; justify-content:center; color:#DC2626; background:#FEF2F2; border:1px solid #FECACA; font-size:11.5px; font-weight:600; display:flex; align-items:center; gap:6px;" onclick="deleteThisBrand(<?php echo (int)$brand_id; ?>)">
...
function deleteThisBrand(id) {
    const doDel = function() {
        ...
        .then(() => {
            if (typeof window.showToast === 'function') window.showToast('Brand deleted from database', 'success');
            setTimeout(() => window.location.href = '/admin/products/brands/', 400);
        });
    };
    ...
    if (window.DTProducts && typeof window.DTProducts.confirmModal === 'function') {
        window.DTProducts.confirmModal(
            'Delete Brand',
            'Are you sure you want to permanently delete this brand from database?',
            doDel,
            'Delete Permanently',
            true
        );
