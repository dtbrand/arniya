...
/**
 * Best Sellers Hub — DT Brand's Master Wholesale Suite
 * DT Brand's & Jai Hanuman Tex
 */
$page_title = "Best Sellers Hub";
$active_nav = "products";
...
<head>
    ...
    <title>Best Sellers Hub ‹ DT Brand's Admin</title>
        ...
        <main class="adm-content" style="padding: 16px 20px;">
            ...
            <div class="dt-kpi-ribbon">
                <div class="dt-kpi-card">
                    ...
                    <div>
                        <div style="font-size:11px; color:#646970; font-weight:600;">BEST SELLER B2B DESIGNS</div>
