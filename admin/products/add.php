        ...
        <main class="adm-content" style="padding: 12px 16px;">
            ...
            <div class="wp-heading-wrap" style="justify-content: space-between; border-bottom: 1px solid #c3c4c7; padding-bottom: 10px; margin-bottom: 14px;">
                ...
                <div style="display:flex; align-items:center; gap:6px; flex-wrap:wrap;">
                    <a href="/admin/products/" class="wp-button adm-btn-pale">
                    ...
                    <button type="button" class="wp-button adm-btn-pale" data-dt-save onclick="window.saveProductToDatabase && window.saveProductToDatabase(true);">
                    ...
                    <button type="button" class="wp-button primary adm-btn-gold" data-dt-save onclick="window.saveProductToDatabase && window.saveProductToDatabase(false);">
