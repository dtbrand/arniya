...
<div id="dtCustBulkBar" class="dt-cust-bulk-bar">
    ...
    <div style="display:flex; align-items:center; gap:8px;">
        ...
        <button type="button" class="dt-btn dt-btn-sm" onclick="bulkDeleteCustomers()" style="background:#DC2626; color:#FFFFFF; border:1px solid #B91C1C; font-weight:800; display:inline-flex; align-items:center; gap:5px; cursor:pointer;" title="Permanently Delete Selected Customers from Database">
