...
/**
 * wholesalers.php — Wholesale B2B Master Partner Hub
...
foreach ($customersList as $c) {
    if (($c['type'] ?? '') === 'wholesale') {
        $wholesaleCount++;
        $wholesaleSpend += (float)($c['lifetime_spend'] ?? 0);
    }
}

$page_title = "Wholesale B2B Master Accounts";
$active_nav = "customers";
$active_subnav = "wholesalers";
$active_filter = "wholesale";
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="dt-cust-head">
                    <div class="dt-cust-title-group">
                        <h1 class="dt-cust-title">
                            <span>Wholesale B2B Master Directory</span>
                            <span class="dt-cust-badge gold"><?php echo number_format($wholesaleCount); ?> Wholesalers</span>
                        </h1>
                        <p class="dt-cust-subtitle">Manage verified textile wholesalers, regional depot accounts, GSTIN/PAN compliance, credit limits, and full-set / master bale volume pricing.</p>
                    </div>
                    <div class="dt-cust-actions">
                        ...
                        <a href="/admin/customers/pending.php" class="dt-btn dt-btn-pale">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="margin-right:4px;"><path d="M9 12l2 2 4-4"></path><circle cx="12" cy="12" r="10"></circle></svg>
                            <span>Trade Approvals</span>
                        </a>
                        <a href="/admin/customers/export.php?type=wholesale" class="dt-btn dt-btn-gold">
                            ...
                            <span>Export Wholesalers CSV</span>
                        </a>
                        <a href="/admin/customers/new.php?type=wholesale" class="dt-btn dt-btn-dark">
...
document.addEventListener('DOMContentLoaded', function () {
    if (typeof filterCustomersByStatus === 'function') {
        filterCustomersByStatus('wholesale');
    }
});
</script>
</body>
