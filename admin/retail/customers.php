...
<head>
    ...
    <link rel="stylesheet" href="/admin/retail/assets/css/retail-customers.css?v=<?php echo time(); ?>">
</head>
<body>
            ...
            <div class="dt-retail-container">
                <div class="dt-retail-head">
                    ...
                    <div style="display:flex; align-items:center; gap:8px;">
                        <a href="/admin/retail/segments.php" class="dt-btn dt-btn-pale">
                        ...
                        <a href="/admin/customers/" class="dt-btn dt-btn-gold">
