...
<head>
    ...
    <link rel="stylesheet" href="/admin/retail/assets/css/retail-discounts.css?v=<?php echo time(); ?>">
</head>
<body>
...
<script src="/admin/retail/assets/js/retail-discounts.js?v=<?php echo time(); ?>"></script>
</body>
</html>
