                                ...
                                <tr id="subcat-<?php echo (int)$s['id']; ?>">
                                    ...
                                    <td style="text-align:right;">
                                        <div style="display:inline-flex; gap:4px;">
                                            ...
                                            <button type="button" class="dt-btn-action-sm danger" onclick="if(confirm('Delete subcategory &quot;<?php echo htmlspecialchars(addslashes((string)$s['name'])); ?>&quot;?')) { fetch('/api/categories.php', { method: 'DELETE', credentials:'same-origin', headers:{'Content-Type':'application/json'}, body: JSON.stringify({action:'delete_subcategory', id: <?php echo (int)$s['id']; ?>}) }).then(() => window.location.reload()); }" style="height:24px; padding:0 6px; display:inline-flex; align-items:center; justify-content:center;" title="Delete Subcategory"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
