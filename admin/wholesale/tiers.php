...
<head>
    ...
    <link rel="stylesheet" href="/admin/wholesale/assets/css/wholesale-tiers.css?v=<?php echo time(); ?>">
</head>
<body>
...
<script src="/admin/wholesale/assets/js/wholesale-tiers.js?v=<?php echo time(); ?>"></script>
</body>
</html>
