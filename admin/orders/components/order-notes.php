    ...
    <div class="dt-detail-card-body" style="padding:14px 16px; display:flex; flex-direction:column; gap:12px;">
        ...
        <div class="dt-notes-list" id="adminNotesList" style="display:flex; flex-direction:column; gap:10px;">
            ...
            <div class="dt-smart-note-card" id="<?php echo $n['id']; ?>" style="background:#FAF8F4; border:1px solid #E2DFD7; border-left:3.5px solid <?php echo ($n['tag_class'] === 'emerald') ? '#15803D' : '#8A681F'; ?>; border-radius:8px; padding:10px 12px; transition:all 0.15s ease;">
                ...
                <div style="display:flex; justify-content:flex-end; gap:6px; margin-top:6px;">
                    <button type="button" onclick="window.DT_ORDER_VIEW.copyNoteText(this)" class="dt-btn dt-btn-pale dt-note-util-btn" style="padding:2px 8px; font-size:10.5px; height:24px; display:inline-flex; align-items:center; gap:4px;" title="Copy Note Text">
                    ...
                    <button type="button" onclick="window.DT_ORDER_VIEW.deleteNote('<?php echo $n['id']; ?>')" class="dt-btn dt-btn-pale dt-note-util-btn" style="padding:2px 8px; font-size:10.5px; height:24px; color:#DC2626; border-color:#FECACA; display:inline-flex; align-items:center; gap:4px;" title="Delete Note">
        ...
        <div style="background:#FDFBF7; border:1.5px solid #D4AF37; border-radius:8px; padding:12px 14px; margin-top:4px; box-shadow:0 2px 6px rgba(212,175,55,0.1);">
            ...
            <div style="display:flex; align-items:center; gap:5px; flex-wrap:wrap; margin-bottom:10px;">
                ...
                <button type="button" onclick="window.DT_ORDER_VIEW.insertNoteSnippet('Manifest verified with Surat floor. Ready for dock handover.')" class="dt-btn dt-btn-pale dt-snippet-btn" style="padding:2px 8px; font-size:10px; height:24px;">+ Manifest Verified</button>
                <button type="button" onclick="window.DT_ORDER_VIEW.insertNoteSnippet('Packed in heavy-duty tamper proof master carton with Silk Mark tag.')" class="dt-btn dt-btn-pale dt-snippet-btn" style="padding:2px 8px; font-size:10px; height:24px;">+ Packed in Carton</button>
                <button type="button" onclick="window.DT_ORDER_VIEW.insertNoteSnippet('Payment UTR confirmed via ICICI bank portal.')" class="dt-btn dt-btn-pale dt-snippet-btn" style="padding:2px 8px; font-size:10px; height:24px;">+ UTR Confirmed</button>
                <button type="button" onclick="window.DT_ORDER_VIEW.insertNoteSnippet('Buyer requested priority cargo transit delivery before Monday.')" class="dt-btn dt-btn-pale dt-snippet-btn" style="padding:2px 8px; font-size:10px; height:24px;">+ Priority Transit</button>
            </div>
