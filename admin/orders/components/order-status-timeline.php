...
<div class="dt-detail-card">
    <div class="dt-detail-card-head">
        ...
        <div style="display:flex; align-items:center; gap:6px;">
            <button type="button" class="dt-btn dt-btn-pale" style="height:26px; padding:0 10px; font-size:10.5px;" onclick="window.DT_ORDER_STATUS.openStatusModal('<?php echo htmlspecialchars($order['id'] ?? ''); ?>', '<?php echo htmlspecialchars($current_order_status); ?>')">
    ...
    <div class="dt-detail-card-body" style="padding:10px 16px 16px 16px;">
        <div class="dt-status-stepper">
            ...
            ?>
            <div class="dt-step-node <?php echo $cls; ?>" style="cursor:pointer;" onclick="window.DT_ORDER_STATUS.openStatusModal('<?php echo htmlspecialchars($order['id'] ?? ''); ?>', '<?php echo $s['key']; ?>')" title="Click to transition to <?php echo $s['label']; ?>">
