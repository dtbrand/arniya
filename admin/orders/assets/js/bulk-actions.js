                ...
                invoicesHtml += `
                    <div class="invoice-page" style="page-break-after: ${isLast ? 'auto' : 'always'}; margin-bottom: 24px; padding: 20px; font-family: 'Plus Jakarta Sans', Arial, sans-serif; font-size: 11.5px; color: #181512; box-sizing: border-box;">
                        ...
                        <div style="display:flex; justify-content:space-between; align-items:center; background:#FAF5E8; border:1.5px solid #8A681F; border-radius:6px; padding:10px 14px;">
                            ...
                            <div style="font-size:14px; font-weight:800; color:#181512; display:inline-flex; align-items:center;">Grand Total:&nbsp;<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-1px; margin-right:2px;" aria-hidden="true"><path d="M6 3h12M6 8h12M6 13l8.5 8M6 13h3a4 4 0 0 0 0-8"></path></svg>${grandTotal.toLocaleString('en-IN', {minimumFractionDigits:2, maximumFractionDigits:2})}</div>
                        </div>
                    </div>
                `;
            });
