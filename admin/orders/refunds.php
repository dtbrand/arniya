...
<head>
    ...
    <link rel="stylesheet" href="/admin/orders/assets/css/refunds.css?v=<?= @filemtime(__DIR__ . '/assets/css/refunds.css') ?: '3.2.1' ?>">
</head>
<body>
                    ...
                    <div class="dt-orders-title-group">
                        <h1 class="dt-orders-title">
                            ...
                            <span class="dt-title-counter-badge">
                                ...
                                <strong style="display:inline-flex; align-items:center;"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-1px; margin-right:2px;" aria-hidden="true"><path d="M6 3h12M6 8h12M6 13l8.5 8M6 13h3a4 4 0 0 0 0-8"></path></svg><?php echo number_format($totalSettled); ?></strong> Settled
                            </span>
                        </h1>
                        ...
                        <div class="dt-col-dropdown-wrap" style="position:relative;">
                            ...
                            <div id="refundColumnVisibilityMenu" class="dt-col-menu" style="display:none; position:absolute; right:0; top:calc(100% + 6px); width:230px; background:#FFFFFF; border:1px solid #D4AF37; border-radius:8px; box-shadow:0 8px 24px rgba(0,0,0,0.14); padding:10px 12px; z-index:99999;">
                                ...
                                <div style="display:flex; flex-direction:column; gap:5px; font-size:11px; color:#1E293B;">
                                    ...
                                    <label style="display:flex; align-items:center; gap:6px; cursor:pointer;"><input type="checkbox" data-col="col-ref-amount" checked onchange="window.DT_REFUNDS.toggleColumn('col-ref-amount', this.checked)"> <span style="display:inline-flex; align-items:center;">Amount (<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-1px;" aria-hidden="true"><path d="M6 3h12M6 8h12M6 13l8.5 8M6 13h3a4 4 0 0 0 0-8"></path></svg>)</span></label>
