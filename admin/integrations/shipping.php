<?php
/**
 * admin/integrations/shipping.php — Shipping & Logistics Integration Console
...
$page_title = "Shipping & Logistics Integrations";
$active_nav = "integrations";
$active_subnav = "shipping";

$shippingGateways = $manager->getAll('shipping');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Shipping &amp; Logistics — DT Brand's Admin</title>
...
<div class="adm-layout">
    ...
    <div class="adm-main">
        ...
        <main class="adm-content">
            ...
            <div class="adm-page-head" style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px; margin-bottom:24px;">
                <div class="adm-page-title-group">
                    <h1 class="adm-page-title" style="display:flex; align-items:center; gap:10px; margin:0;">
                        <span>Shipping &amp; Logistics Integrations</span>
                        <span class="adm-badge gold" style="font-size:0.72rem; font-weight:800;">PAN-INDIA DISPATCH</span>
                    </h1>
                    <p class="adm-page-subtitle" style="margin:4px 0 0 0; color:#64748B; font-size:0.82rem;">
                        Automated AWB generation, live tracking webhooks, and B2B surface cargo routing.
                    </p>
                </div>
            ...
            <!-- Logistics Architecture Highlight -->
            <div style="background:#F8FAFC; border:1px solid #E2E8F0; border-radius:12px; padding:18px 20px; margin-bottom:24px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:16px;">
                <div>
                    <div style="font-size:0.95rem; font-weight:800; color:#111827; display:flex; align-items:center; gap:8px;">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#8A681F" stroke-width="2.2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                        <span>Surat Central Distribution Hub (Pincode: 395002)</span>
                    </div>
                    <div style="font-size:0.8rem; color:#475569; margin-top:4px;">
                        B2C Retail/Reseller Parcels ➔ <strong>Delhivery Express &amp; BlueDart Air</strong> | Wholesaler B2B Lots ➔ <strong>TCI Freight Surface Cargo</strong>
                    </div>
                </div>
                <div style="display:flex; align-items:center; gap:10px;">
                    <span class="itg-status-badge active"><span class="itg-pulse-dot"></span> 28,000+ Pincodes Serviceable</span>
                </div>
            </div>

            <!-- Gateways List -->
            <div class="itg-cards-grid">
                <?php foreach ($shippingGateways as $item): ?>
                    <?php
                        ...
                        <div>
                            <div class="itg-card-header">
                                <div class="itg-card-brand">
                                    ...
                                    <div>
                                        <div class="itg-card-cat">LOGISTICS PARTNER</div>
                            ...
                            <div class="itg-metrics-row">
                                ...
                                <div class="itg-metric-item">
                                    <span class="itg-metric-label">Last Ping</span>
                                ...
                                <div class="itg-metric-item">
                                    ...
                                    <span class="itg-metric-val" style="color:<?php echo $hasWebhook ? '#15803D' : '#64748B'; ?>;">
                                        <?php echo $hasWebhook ? 'Active Listener' : 'Polling'; ?>
                                    </span>
                                </div>
                            </div>
                        </div>
