<?php
/**
 * shipping-policy.php — ARNIYA Admin Cms Module
 * DT Brand's & Jai Hanuman Tex
 */

$page_title = 'Cms — Shipping Policy';
$active_nav = 'cms';
$extra_css = ['/Admin/cms/cms.css'];
$extra_js = ['/Admin/cms/cms.js'];
        ...
        <section class="adm-dash-header">
            <div class="adm-dash-title-group">
                ...
                <h1 class="adm-dash-title">
                    <span>Cms — Shipping Policy</span>
                    <span class="adm-badge gold">CMS MODULE</span>
                </h1>
                <p class="adm-dash-subtitle">Manage and configure cms data for ARNIYA e-commerce platform.</p>
            </div>
        ...
        <section class="adm-card">
            <div class="adm-card-head">
                <div class="adm-card-title-wrap">
                    <h2 class="adm-card-title">📋 Cms — Shipping Policy Overview</h2>
            ...
            <div style="padding:24px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed var(--adm-border-soft);">
                ...
                <h3 style="font-size:1.1rem; font-weight:800; color:var(--adm-text-main);">Cms — Shipping Policy Module Ready</h3>
                ...
                <div style="display:flex; justify-content:center; gap:10px;">
                    <a href="/Admin/cms/" class="adm-btn-secondary">View Module Index</a>
