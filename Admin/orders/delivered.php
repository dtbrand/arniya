<?php
/**
 * delivered.php — ARNIYA Admin Orders Module
 * DT Brand's & Jai Hanuman Tex
 */

$page_title = 'Orders — Delivered';
$active_nav = 'orders';
        ...
        <section class="adm-card">
            <div class="adm-card-head">
                <div class="adm-card-title-wrap">
                    <h2 class="adm-card-title">📋 Orders — Delivered Overview</h2>
            ...
            <div style="padding:24px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed var(--adm-border-soft);">
                ...
                <h3 style="font-size:1.1rem; font-weight:800; color:var(--adm-text-main);">Orders — Delivered Module Ready</h3>
