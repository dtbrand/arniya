<?php
/**
 * bulk.php — ARNIYA Admin Pricing Module
 * DT Brand's & Jai Hanuman Tex
 */

$page_title = 'Pricing — Bulk';
$active_nav = 'pricing';
        ...
        <section class="adm-card">
            <div class="adm-card-head">
                <div class="adm-card-title-wrap">
                    <h2 class="adm-card-title">📋 Pricing — Bulk Overview</h2>
            ...
            <div style="padding:24px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed var(--adm-border-soft);">
                ...
                <h3 style="font-size:1.1rem; font-weight:800; color:var(--adm-text-main);">Pricing — Bulk Module Ready</h3>
