<?php
/**
 * reported.php — ARNIYA Admin Reviews Module
 * DT Brand's & Jai Hanuman Tex
 */

$page_title = 'Reviews — Reported';
$active_nav = 'reviews';
$extra_css = ['/Admin/reviews/reviews.css'];
$extra_js = ['/Admin/reviews/reviews.js'];
        ...
        <section class="adm-dash-header">
            <div class="adm-dash-title-group">
                ...
                <h1 class="adm-dash-title">
                    <span>Reviews — Reported</span>
                    <span class="adm-badge gold">REVIEWS MODULE</span>
                </h1>
                <p class="adm-dash-subtitle">Manage and configure reviews data for ARNIYA e-commerce platform.</p>
            </div>
        ...
        <section class="adm-card">
            <div class="adm-card-head">
                <div class="adm-card-title-wrap">
                    <h2 class="adm-card-title">📋 Reviews — Reported Overview</h2>
            ...
            <div style="padding:24px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed var(--adm-border-soft);">
                ...
                <h3 style="font-size:1.1rem; font-weight:800; color:var(--adm-text-main);">Reviews — Reported Module Ready</h3>
                ...
                <div style="display:flex; justify-content:center; gap:10px;">
                    <a href="/Admin/reviews/" class="adm-btn-secondary">View Module Index</a>
