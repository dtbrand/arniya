<?php
/**
 * login-history.php — ARNIYA Admin Users Module
 * DT Brand's & Jai Hanuman Tex
 */

$page_title = 'Users — Login History';
$active_nav = 'users';
$extra_css = ['/Admin/users/users.css'];
$extra_js = ['/Admin/users/users.js'];
        ...
        <section class="adm-dash-header">
            <div class="adm-dash-title-group">
                ...
                <h1 class="adm-dash-title">
                    <span>Users — Login History</span>
                    <span class="adm-badge gold">USERS MODULE</span>
                </h1>
                <p class="adm-dash-subtitle">Manage and configure users data for ARNIYA e-commerce platform.</p>
            </div>
        ...
        <section class="adm-card">
            <div class="adm-card-head">
                <div class="adm-card-title-wrap">
                    <h2 class="adm-card-title">📋 Users — Login History Overview</h2>
            ...
            <div style="padding:24px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed var(--adm-border-soft);">
                ...
                <h3 style="font-size:1.1rem; font-weight:800; color:var(--adm-text-main);">Users — Login History Module Ready</h3>
                ...
                <div style="display:flex; justify-content:center; gap:10px;">
                    <a href="/Admin/users/" class="adm-btn-secondary">View Module Index</a>
