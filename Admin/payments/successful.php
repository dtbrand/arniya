<?php
/**
 * successful.php — ARNIYA Admin Payments Module
 * DT Brand's & Jai Hanuman Tex
 */

$page_title = 'Payments — Successful';
$active_nav = 'payments';
$extra_css = ['/Admin/payments/payments.css'];
$extra_js = ['/Admin/payments/payments.js'];
        ...
        <section class="adm-dash-header">
            <div class="adm-dash-title-group">
                ...
                <h1 class="adm-dash-title">
                    <span>Payments — Successful</span>
                    <span class="adm-badge gold">PAYMENTS MODULE</span>
                </h1>
                <p class="adm-dash-subtitle">Manage and configure payments data for ARNIYA e-commerce platform.</p>
            </div>
        ...
        <section class="adm-card">
            <div class="adm-card-head">
                <div class="adm-card-title-wrap">
                    <h2 class="adm-card-title">📋 Payments — Successful Overview</h2>
            ...
            <div style="padding:24px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed var(--adm-border-soft);">
                ...
                <h3 style="font-size:1.1rem; font-weight:800; color:var(--adm-text-main);">Payments — Successful Module Ready</h3>
                ...
                <div style="display:flex; justify-content:center; gap:10px;">
                    <a href="/Admin/payments/" class="adm-btn-secondary">View Module Index</a>
