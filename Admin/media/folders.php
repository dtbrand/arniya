<?php
/**
 * folders.php — ARNIYA Admin Media Module
 * DT Brand's & Jai Hanuman Tex
 */

$page_title = 'Media — Folders';
$active_nav = 'media';
$extra_css = ['/Admin/media/media.css'];
$extra_js = ['/Admin/media/media.js'];
        ...
        <section class="adm-dash-header">
            <div class="adm-dash-title-group">
                ...
                <h1 class="adm-dash-title">
                    ...
                    <span class="adm-badge gold">MEDIA MODULE</span>
                </h1>
                <p class="adm-dash-subtitle">Manage and configure media data for ARNIYA e-commerce platform.</p>
            </div>
        ...
        <section class="adm-card">
            <div class="adm-card-head">
                <div class="adm-card-title-wrap">
                    <h2 class="adm-card-title">📋 Media — Folders Overview</h2>
            ...
            <div style="padding:24px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed var(--adm-border-soft);">
                ...
                <h3 style="font-size:1.1rem; font-weight:800; color:var(--adm-text-main);">Media — Folders Module Ready</h3>
                ...
                <div style="display:flex; justify-content:center; gap:10px;">
                    <a href="/Admin/media/" class="adm-btn-secondary">View Module Index</a>
