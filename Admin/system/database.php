<?php
/**
 * database.php — ARNIYA Admin System Module
 * DT Brand's & Jai Hanuman Tex
 */

$page_title = 'System — Database';
$active_nav = 'system';
$extra_css = ['/Admin/system/system.css'];
$extra_js = ['/Admin/system/system.js'];
        ...
        <section class="adm-dash-header">
            <div class="adm-dash-title-group">
                ...
                <h1 class="adm-dash-title">
                    ...
                    <span class="adm-badge gold">SYSTEM MODULE</span>
                </h1>
                <p class="adm-dash-subtitle">Manage and configure system data for ARNIYA e-commerce platform.</p>
            </div>
        ...
        <section class="adm-card">
            <div class="adm-card-head">
                <div class="adm-card-title-wrap">
                    <h2 class="adm-card-title">📋 System — Database Overview</h2>
            ...
            <div style="padding:24px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed var(--adm-border-soft);">
                ...
                <h3 style="font-size:1.1rem; font-weight:800; color:var(--adm-text-main);">System — Database Module Ready</h3>
                ...
                <div style="display:flex; justify-content:center; gap:10px;">
                    <a href="/Admin/system/" class="adm-btn-secondary">View Module Index</a>
