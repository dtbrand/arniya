<?php
/**
 * performance.php — ARNIYA Admin Resellers Module
 * DT Brand's & Jai Hanuman Tex
 */

$page_title = 'Resellers — Performance';
$active_nav = 'resellers';
$extra_css = ['/Admin/resellers/resellers.css'];
$extra_js = ['/Admin/resellers/resellers.js'];
        ...
        <section class="adm-dash-header">
            <div class="adm-dash-title-group">
                ...
                <h1 class="adm-dash-title">
                    <span>Resellers — Performance</span>
                    <span class="adm-badge gold">RESELLERS MODULE</span>
                </h1>
                <p class="adm-dash-subtitle">Manage and configure resellers data for ARNIYA e-commerce platform.</p>
            </div>
        ...
        <section class="adm-card">
            <div class="adm-card-head">
                <div class="adm-card-title-wrap">
                    <h2 class="adm-card-title">📋 Resellers — Performance Overview</h2>
            ...
            <div style="padding:24px; text-align:center; background:#FAF8F4; border-radius:8px; border:1px dashed var(--adm-border-soft);">
                ...
                <h3 style="font-size:1.1rem; font-weight:800; color:var(--adm-text-main);">Resellers — Performance Module Ready</h3>
                ...
                <div style="display:flex; justify-content:center; gap:10px;">
                    <a href="/Admin/resellers/" class="adm-btn-secondary">View Module Index</a>
