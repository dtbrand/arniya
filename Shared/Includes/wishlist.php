        ...
        if (items.length === 0) {
            ...
            var sliderCardsHtml = fullList.map(function(p) {
                return '<div class="wd-rec-card">' +
                    '<div class="wd-rec-img-wrap">' +
                        '<img src="' + p.image + '" alt="' + p.name + '" class="wd-rec-img" /Shared/Asset/images/product1.png'" />' +
                    '</div>' +
            ...
            items.forEach(function(item, idx) {
                ...
                html += '<div class="wd-item" data-index="' + idx + '">' +
                    '<img src="' + imgUrl + '" alt="' + item.name + '" class="wd-item-img" /Shared/Asset/images/product1.png'" />' +
