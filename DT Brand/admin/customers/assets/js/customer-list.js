                ...
                <tr class="${isChecked ? 'selected' : ''}" data-cust-id="${c.id}">
                        ...
                        <div class="dt-cust-avatar-cell">
                            ...
                            <div class="dt-cust-name-wrap">
                                <div class="dt-cust-name-row">
                                    <a href="/DT%20Brand/admin/customers/view.php?id=${c.id}" class="dt-cust-name">${c.name}</a>
                    ...
                    <td style="text-align:right;">
                        <div class="dt-cust-actions-cell">
                            ...
                            <a href="/DT%20Brand/admin/customers/view.php?id=${c.id}" class="dt-cust-act-btn view" title="View 360° Profile">
                            ...
                            <a href="/DT%20Brand/admin/customers/edit.php?id=${c.id}" class="dt-cust-act-btn edit" title="Edit Customer">
