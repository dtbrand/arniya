...
<div class="dt-cust-table-wrap" style="border:none; box-shadow:none;">
    <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:12px;">
        ...
        <a href="/admin/orders/index.php?search=<?php echo $customer_id; ?>" class="dt-btn dt-btn-pale dt-btn-sm">View Full Order Stream →</a>
    </div>
    ...
    <table class="dt-cust-table" style="min-width:700px;">
        ...
        <tbody>
            <tr>
                <td><a href="/admin/orders/view.php?id=ORD-9842" style="color:#8A681F; font-weight:800; text-decoration:none; font-family:monospace;">#ORD-9842</a></td>
                ...
                <td style="text-align:right;">
                    <a href="/admin/orders/view.php?id=ORD-9842" class="dt-cust-act-btn" title="View Order Details">
            ...
            <tr>
                <td><a href="/admin/orders/view.php?id=ORD-9418" style="color:#8A681F; font-weight:800; text-decoration:none; font-family:monospace;">#ORD-9418</a></td>
                <td>04 Mar 2026</td>
                ...
                <td style="text-align:right;">
                    <a href="/admin/orders/view.php?id=ORD-9418" class="dt-cust-act-btn" title="View Order Details">
                        <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.3"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                    </a>
                </td>
            </tr>
            <tr>
                <td><a href="/admin/orders/view.php?id=ORD-8920" style="color:#8A681F; font-weight:800; text-decoration:none; font-family:monospace;">#ORD-8920</a></td>
                <td>18 Jan 2026</td>
                ...
                <td><span class="dt-status-pill active" style="font-size:0.65rem;">● Delivered</span></td>
                <td style="text-align:right;">
                    <a href="/admin/orders/view.php?id=ORD-8920" class="dt-cust-act-btn" title="View Order Details">
                        <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.3"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                    </a>
                </td>
            </tr>
