...
<div class="dt-page-subnav" style="margin-bottom:14px; gap:8px;">
    <a href="/DT%20Brand/admin/catalogue/seo/index.php" class="dt-subnav-pill <?php echo ($current_seo_tab === 'index.php') ? 'active' : ''; ?>" style="text-decoration:none;">
    ...
    <a href="/DT%20Brand/admin/catalogue/seo/category.php" class="dt-subnav-pill <?php echo ($current_seo_tab === 'category.php') ? 'active' : ''; ?>" style="text-decoration:none;">
    ...
    <a href="/DT%20Brand/admin/catalogue/seo/collections.php" class="dt-subnav-pill <?php echo ($current_seo_tab === 'collections.php') ? 'active' : ''; ?>" style="text-decoration:none;">
