...
<div class="dt-cat-kpi-grid">
    ...
    <a href="/DT%20Brand/admin/catalogue/categories/" class="dt-cat-kpi-card">
    ...
    <a href="/DT%20Brand/admin/catalogue/subcategories/" class="dt-cat-kpi-card">
    ...
    <a href="/DT%20Brand/admin/catalogue/collections/" class="dt-cat-kpi-card">
    ...
    <a href="/DT%20Brand/admin/products/" class="dt-cat-kpi-card">
        <div class="dt-cat-kpi-icon" style="background:#FAF5E8; border:1px solid #D4AF37; color:#8A681F;">
