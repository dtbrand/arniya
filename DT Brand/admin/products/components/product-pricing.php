...
/**
 * product-pricing.php — Pricing Studio (Clean B2B Trade vs. Customer Price & Flat Sale Discount)
...
<div class="dt-form-section">
    ...
    <div class="dt-form-sec-body">
        <div class="adm-form-grid" style="display:grid; grid-template-columns:repeat(auto-fit, minmax(220px, 1fr)); gap:12px;">
            ...
            <!-- 1. B2B Trade Base Price (Price Column for Retailers/Boutiques, Resellers, Wholesalers) -->
            <div class="adm-form-group">
                <label class="adm-form-label" for="pFormRetail">
                    Price &#8377; <span style="font-size:10px; font-weight:800; color:#8A681F;">(B2B Trade / Retailer / Reseller / Wholesaler)</span> <span style="color:#b32d2e;">*</span>
                </label>
            ...
            <!-- 3. Sale Price Discount (Flat Less Amount: e.g. 20, 30, 50, 100) -->
            <div class="adm-form-group">
                ...
                <input type="number" min="0" step="1" id="pFormSalePrice" class="adm-form-input" style="font-weight:700; color:#B45309; font-size:13px;"
                       ...
                       oninput="if (window.calcPricePreview) window.calcPricePreview();">
                <small style="font-size:10px; color:#64748B;">Flat discount deducted from Price and Customer Price.</small>
            </div>
        </div>
        ...
        <!-- ══ LIVE ROLE PRICE & MARGIN BREAKDOWN RIBBON ══ -->
        <div id="dtLiveRolePricingBreakdown" style="margin-top:12px; background:linear-gradient(135deg, #181512 0%, #2A241E 100%); border:1.5px solid #D4AF37; border-radius:8px; padding:10px 14px; color:#FAF5E8; box-shadow:0 3px 12px rgba(0,0,0,0.25);">
            <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:8px; border-bottom:1px solid rgba(212,175,55,0.25); padding-bottom:8px; margin-bottom:10px;">
                <div style="display:flex; align-items:center; gap:6px;">
                    ...
                    <span style="font-size:11.5px; font-weight:800; color:#FAF5E8; letter-spacing:0.2px;">LIVE PRICE &amp; MARGIN BREAKDOWN</span>
                </div>
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(180px, 1fr)); gap:10px; align-items:center;">
                <!-- 1. Customer / Guest -->
                <div style="background:rgba(255,255,255,0.06); border:1px solid rgba(255,255,255,0.1); border-radius:6px; padding:8px 12px;">
                    <div style="font-size:9.5px; font-weight:700; color:#A1A1AA; text-transform:uppercase;">Customer &amp; Guest Price</div>
                    <div id="dispCustPrice" style="font-size:16px; font-weight:800; color:#34D399; margin-top:2px;">&#8377;0</div>
                    <div id="dispCustSub" style="font-size:9.5px; color:#D1D5DB;">End Consumer Rate</div>
                </div>

                <!-- 2. B2B Trade Price (Retailer / Boutique / Reseller / Wholesaler) -->
                <div style="background:rgba(212,175,55,0.12); border:1.2px solid #D4AF37; border-radius:6px; padding:8px 12px;">
                    <div style="font-size:9.5px; font-weight:800; color:#FCD34D; text-transform:uppercase;">B2B Trade Price (Boutique / Reseller)</div>
                    <div id="dispRetailerPrice" style="font-size:16px; font-weight:800; color:#FCD34D; margin-top:2px;">&#8377;0</div>
                    <div id="dispRetailerSub" style="font-size:9.5px; color:#FAF5E8;">B2B Trade Rate</div>
                </div>

                <!-- 3. Boutique / Retailer Profit Margin -->
                <div style="background:rgba(16,185,129,0.15); border:1px solid #10B981; border-radius:6px; padding:8px 12px;">
                    <div style="font-size:9.5px; font-weight:800; color:#6EE7B7; text-transform:uppercase;">Boutique Seller Margin</div>
                    <div id="dispBoutiqueMargin" style="font-size:16px; font-weight:800; color:#6EE7B7; margin-top:2px;">&#8377;0/pc</div>
                    <div id="dispMarginPercent" style="font-size:9.5px; color:#A7F3D0;">0% Profit Spread</div>
                </div>
            </div>
        </div>
    </div>
