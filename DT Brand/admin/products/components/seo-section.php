...
/**
 * seo-section.php — SEO Fields & Google Search Snippet Preview
 */
?>
    ...
    <div class="dt-form-sec-body">
        <div class="adm-form-grid">
            <div class="adm-form-group full">
                ...
                <input type="text" id="pFormSeoTitle" class="adm-form-input" placeholder="e.g. Pure Silk Sarees Online - Surat Weaving | DT Brand's" oninput="window.updateGoogleSeoPreview()">
            </div>
            <div class="adm-form-group full">
                <label class="adm-form-label">Meta Description</label>
                <textarea id="pFormSeoDesc" class="adm-form-textarea" rows="2" placeholder="Handcrafted pure silk sarees woven with authentic zari border. Order wholesale lots or single pieces directly from Surat mills." oninput="window.updateGoogleSeoPreview()"></textarea>
            </div>
            <div class="adm-form-group">
                <label class="adm-form-label">URL Slug</label>
                <input type="text" id="pFormSlug" class="adm-form-input" placeholder="kanjivaram-pure-silk-saree" oninput="window.updateGoogleSeoPreview()">
            </div>
            <div class="adm-form-group">
