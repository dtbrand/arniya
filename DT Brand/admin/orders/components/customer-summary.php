...
<div class="dt-detail-card">
    ...
    <div class="dt-detail-card-body" style="display:flex; flex-direction:column; gap:10px;">
        ...
        <div style="display:flex; gap:6px;">
            ...
            <a href="/DT%20Brand/admin/orders/ledger.php?id=<?php echo urlencode($order['id'] ?? ($order_id ?? 'DTB-001624')); ?>" target="_blank" class="dt-btn dt-btn-pale" style="flex:1; height:30px; font-size:11px;">
