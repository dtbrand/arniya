...
<head>
    ...
    <link rel="stylesheet" href="/DT%20Brand/admin/retail/assets/css/retail-checkout.css?v=<?php echo time(); ?>">
</head>
<body>
...
<script src="/DT%20Brand/admin/retail/assets/js/retail-checkout.js?v=<?php echo time(); ?>"></script>
</body>
</html>
