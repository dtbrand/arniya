...
<head>
    ...
    <link rel="stylesheet" href="/admin/retail/assets/css/retail-checkout.css?v=<?php echo time(); ?>">
</head>
<body>
...
<script src="/admin/retail/assets/js/retail-checkout.js?v=<?php echo time(); ?>"></script>
</body>
</html>
