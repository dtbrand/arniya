...
<head>
    ...
    <link rel="stylesheet" href="/admin/retail/assets/css/retail-dashboard.css?v=<?php echo time(); ?>">
            ...
            <div class="dt-retail-container">
                ...
                <div class="dt-retail-head">
                    ...
                    <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap;">
                        <a href="/admin/retail/customers.php" class="dt-btn dt-btn-pale">
                        ...
                        <a href="/admin/retail/orders.php" class="dt-btn dt-btn-pale">
                        ...
                        <a href="/admin/retail/export.php" class="dt-btn dt-btn-gold">
...
<script src="/admin/retail/assets/js/retail-customers.js?v=<?php echo time(); ?>"></script>
