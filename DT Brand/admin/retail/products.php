...
<head>
    ...
    <link rel="stylesheet" href="/DT%20Brand/admin/retail/assets/css/retail-pricing.css?v=<?php echo time(); ?>">
</head>
<body>
        ...
        <main class="adm-content" style="padding: 18px 20px; width: 100%; max-width: 100%; box-sizing: border-box;">
            ...
            <div class="dt-retail-container">
                <div class="dt-retail-head">
                    ...
                    <a href="/DT%20Brand/admin/products/" class="dt-btn dt-btn-gold">
...
<script src="/DT%20Brand/admin/retail/assets/js/retail-pricing.js?v=<?php echo time(); ?>"></script>
</body>
</html>
