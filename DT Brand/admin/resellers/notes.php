 ...
 * Reseller Internal Staff Notes & Memos
 */
$page_title = "Reseller Staff Notes";
...
<head>
    ...
    <title>Staff Notes - DT Brand's Admin</title>
                ...
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px;">
                    <div>
                        <div style="display:flex; align-items:center; gap:8px;">
                            <h1 style="font-size:1.35rem; font-weight:900; color:#181512; margin:0;">Staff Internal Notes &amp; Memos</h1>
                            <span class="dt-reseller-badge gold">CRM Memos</span>
                        </div>
                        <p style="font-size:0.78rem; color:#78716C; margin:3px 0 0 0;">Internal staff communications, partner trust ratings, and custom arrangement records.</p>
                    </div>
