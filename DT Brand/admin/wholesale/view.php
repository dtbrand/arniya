...
<head>
    ...
    <link rel="stylesheet" href="/admin/wholesale/assets/css/wholesale-view.css?v=<?php echo time(); ?>">
            ...
            <div class="dt-wholesale-container">
                ...
                <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:8px;">
                    ...
                    <div style="display:flex; gap:8px;">
                        <a href="/admin/wholesale/edit.php?id=<?php echo $wholesale['id']; ?>" class="dt-btn dt-btn-pale dt-btn-sm">
                        ...
                        <a href="/admin/wholesale/orders.php?id=<?php echo $wholesale['id']; ?>" class="dt-btn dt-btn-gold dt-btn-sm">
...
<script src="/admin/wholesale/assets/js/wholesale-view.js?v=<?php echo time(); ?>"></script>
...
<script src="/admin/wholesale/assets/js/wholesale-orders.js?v=<?php echo time(); ?>"></script>
</body>
</html>
