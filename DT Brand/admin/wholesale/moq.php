...
<head>
    ...
    <link rel="stylesheet" href="/admin/wholesale/assets/css/wholesale-moq.css?v=<?php echo time(); ?>">
</head>
<body>
...
<script src="/admin/wholesale/assets/js/wholesale-moq.js?v=<?php echo time(); ?>"></script>
</body>
</html>
