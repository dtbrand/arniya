...
<head>
    ...
    <link rel="stylesheet" href="/DT%20Brand/admin/wholesale/assets/css/wholesale-tiers.css?v=<?php echo time(); ?>">
</head>
<body>
...
<script src="/DT%20Brand/admin/wholesale/assets/js/wholesale-tiers.js?v=<?php echo time(); ?>"></script>
</body>
</html>
