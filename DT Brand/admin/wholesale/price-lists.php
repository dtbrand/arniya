...
<head>
    ...
    <link rel="stylesheet" href="/admin/wholesale/assets/css/wholesale-price-list.css?v=<?php echo time(); ?>">
</head>
<body>
...
<script src="/admin/wholesale/assets/js/wholesale-price-list.js?v=<?php echo time(); ?>"></script>
</body>
</html>
