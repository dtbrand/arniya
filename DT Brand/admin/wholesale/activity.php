 ...
 * Wholesale Audit Activity Timeline
 */
$page_title = "Wholesale Activity Log";
...
<head>
    ...
    <title>Activity Log - DT Brand's Admin</title>
                ...
                <div class="dt-cust-head" style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px; margin-bottom:4px;">
                    <div>
                        <h1 class="dt-cust-title" style="font-size:1.35rem; font-weight:900; color:#181512; margin:0;">
                            <span>Wholesale Audit Trail &amp; Activity Log</span>
                        </h1>
                        <p class="dt-cust-subtitle" style="font-size:0.78rem; color:#78716C; margin:3px 0 0 0;">Immutable logging of credit line adjustments, tier promotions, PO approvals, and KYC verifications.</p>
                    </div>
                </div>

                <?php include __DIR__ . '/components/wholesale-activity.php'; ?>
            </div>
