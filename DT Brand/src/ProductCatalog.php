...
class ProductCatalog
{
    private static array $products = [
        ...
        [
            'id' => 9,
            'sku' => 'MN-KRT-901',
            'title' => 'Men\'s Pure Raw Silk Royal Kurta Pajama with Zari Brocade Jacket',
            'name' => 'Men\'s Pure Raw Silk Royal Kurta Pajama with Zari Brocade Jacket',
            'slug' => 'mens-pure-raw-silk-kurta-pajama-zari-brocade-jacket',
            'category' => 'Men\'s Ethnic Wear',
            'fabric' => 'Pure Raw Silk & Banarasi Brocade',
            'weave' => 'Surat Jacquard Handloom Weave',
            'color' => 'Ivory Cream & Royal Gold',
            'colors' => ['Ivory Gold', 'Royal Blue', 'Deep Maroon'],
            'size' => ['38', '40', '42', '44'],
            'mrp' => 8500.00,
            'old_price' => 8500.00,
            'price' => 5999.00,
            ...
            'reseller_price' => 2699.00,
            'reseller_profit' => 800.00,
            'discount' => 29,
            'moq' => 6,
            'stock_qty' => 50,
            'in_stock' => true,
            ...
            'description' => 'Groom & festive edition handcrafted pure raw silk men\'s kurta set paired with tailored churidar and royal banarasi brocade Nehru jacket.',
            'moq_lots' => ['single' => 1, 'half_set' => 4, 'full_set' => 8, 'master_bale' => 24]
        ],
        [
            'id' => 10,
            'sku' => 'MN-DHT-902',
            'title' => 'Men\'s Handloom Tussar Silk Dhoti & Angavastram Stole Set',
            'name' => 'Men\'s Handloom Tussar Silk Dhoti & Angavastram Stole Set',
            'slug' => 'mens-handloom-tussar-silk-dhoti-angavastram-stole-set',
            'category' => 'Men\'s Ethnic Wear',
            'fabric' => 'Pure Handloom Tussar Silk',
            'weave' => 'Temple Korvai Real Zari Border Weave',
            'color' => 'Off-White & Red Korvai Zari',
            'colors' => ['Off-White Gold', 'Cream Red', 'Mustard Gold'],
            'size' => ['Free Size (4.0m + 2.25m)'],
            'mrp' => 4200.00,
            'old_price' => 4200.00,
            'price' => 2899.00,
            'retail_price' => 2899.00,
            'wholesale_price' => 899.00,
            'reseller_price' => 1299.00,
            'reseller_profit' => 400.00,
            'discount' => 31,
            'moq' => 8,
            'stock_qty' => 65,
            ...
            'rating' => 4.8,
            'reviews_count' => 48,
            'badge' => 'Heritage Dhoti',
            'image' => '/assets/images/product1.png',
            'gallery' => [
                '/assets/images/product1.png',
                '/assets/images/product1.webp',
            ],
            'description' => 'Authentic handwoven South Indian & Vedic ritual pure Tussar silk dhoti set featuring tested gold zari temple korvai borders and matching angavastram.',
            'moq_lots' => ['single' => 1, 'half_set' => 4, 'full_set' => 8, 'master_bale' => 24]
        ],
        [
            'id' => 11,
            'sku' => 'MN-SHR-903',
            'title' => 'Men\'s Banarasi Katan Silk Wedding Sherwani Kurta Set',
            'name' => 'Men\'s Banarasi Katan Silk Wedding Sherwani Kurta Set',
            'slug' => 'mens-banarasi-katan-silk-wedding-sherwani-kurta-set',
            'category' => 'Men\'s Ethnic Wear',
            'fabric' => 'Pure Katan Silk Brocade',
            'weave' => 'Varanasi Kadwa Meenakari Floral Weave',
            'color' => 'Royal Emerald Green & Antique Gold',
            'colors' => ['Emerald Gold', 'Ruby Maroon', 'Midnight Blue'],
            'size' => ['38', '40', '42', '44', '46'],
            'mrp' => 12500.00,
            'old_price' => 12500.00,
            'price' => 8999.00,
            'retail_price' => 8999.00,
            'wholesale_price' => 2799.00,
            'reseller_price' => 3999.00,
            'reseller_profit' => 1200.00,
            'discount' => 28,
            'moq' => 4,
            'stock_qty' => 40,
            'in_stock' => true,
            ...
            'description' => 'Grand royal wedding sherwani crafted in authentic Banarasi Katan silk brocade with antique gold kadwa weave, matching silk churidar and stole.',
            'moq_lots' => ['single' => 1, 'half_set' => 4, 'full_set' => 8, 'master_bale' => 24]
        ]
    ];
