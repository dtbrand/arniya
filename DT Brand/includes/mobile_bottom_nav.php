...
<nav class="dt-mobile-bottom-nav" id="dtMobileBottomNav" aria-label="Mobile Bottom Navigation">
    <div class="dt-bottom-nav-pill">
        <!-- Tab 1: Home -->
        <a href="/DT Brand/" class="dt-bottom-tab <?= $currentScript === 'index.php' || $currentScript === 'home.php' ? 'active' : '' ?>">
        ...
        <!-- Tab 2: Shop -->
        <a href="/DT Brand/shop.php" class="dt-bottom-tab <?= $currentScript === 'shop.php' || $currentScript === 'product.php' ? 'active' : '' ?>">
            <div class="dt-tab-icon-wrap">
        ...
        <!-- Tab 3: Reseller -->
        <a href="/DT Brand/reseller.php" class="dt-bottom-tab highlight-tab <?= $currentScript === 'reseller.php' ? 'active' : '' ?>">
            <div class="dt-tab-icon-wrap">
        ...
        <!-- Tab 5: Account -->
        <a href="/DT Brand/account.php" class="dt-bottom-tab <?= $currentScript === 'account.php' ? 'active' : '' ?>">
            <div class="dt-tab-icon-wrap">
