...
$out .= "|---|---|---|---|\n";
$out .= "| **Root Homepage** | `index.php` (modular) | `Frontend/Home/home.php`, `DT Brand/index.php` | Seamless, high-performance home hub with video slider & category feed |\n";
$out .= "| **Storefront Hub** | `shop.php`, `product.php`, `wholesale.php`, `reseller.php`, `retailer.php`, `account.php` | `DT Brand/*.php` | Complete production business logic, real pricing tiers, filters |\n";
$out .= "| **Unified REST API** | `api/*.php` | `DT Brand/api/` + `api/` (Union) | Complete endpoint coverage, `_guard.php` security, JSON responses |\n";
$out .= "| **Core Business Classes** | `src/*.php` | `DT Brand/src/` -> `src/` | Preserve complete `Auth.php` (32KB), `OrderManager.php` (42KB), `DiscountEngine.php` (5.4KB) |\n";
$out .= "| **Admin Panel Suite** | `admin/**` | `admin/` + `DT Brand/admin/` + `Frontend/Admin/` | Full modern admin dashboard, products matrix, variants, order manager |\n";
$out .= "| **Shared Modals & Partials** | `shared/includes/**` | `Shared/Includes/` + `DT Brand/shared/` | Single canonical source for QuickView, SmartShare, Reels, Cart, Wishlist |\n\n";
