...
urls = [
    ...
    ('https://harmitethnic.com/admin/orders/pending.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/orders/shipped.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/orders/ledger.php', 200, 'redirect_ok'),
    ...
    ('https://harmitethnic.com/admin/customers/index.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/customers/view.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/customers/retailers.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/customers/resellers.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/customers/wholesalers.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/customers/pending.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/inventory/index.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/inventory/stock-in.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/inventory/stock-out.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/inventory/adjustment.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/inventory/low-stock.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/inventory/ledger.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/admin/inventory/export.php', 200, 'redirect_ok'),
    ('https://harmitethnic.com/api/brands.php', 200, 'json'),
    ...
    ('https://jaihanumantex.in/admin/orders/pending.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/orders/shipped.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/orders/ledger.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/customers/index.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/customers/view.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/customers/retailers.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/customers/resellers.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/customers/wholesalers.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/customers/pending.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/inventory/index.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/inventory/stock-in.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/inventory/stock-out.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/inventory/adjustment.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/inventory/low-stock.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/inventory/ledger.php', 200, 'redirect_ok'),
    ('https://jaihanumantex.in/admin/inventory/export.php', 200, 'redirect_ok'),
    ...
    ('https://jaihanumantex.in/admin/products/attributes/index.php', 200, 'redirect_ok'),
