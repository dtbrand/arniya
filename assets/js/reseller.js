...
window.animateTargetGauge = animateTargetGauge;
     ...
     // for global access
        ...
        /* ── Load Reseller Profile & State (Real Database Hydration) ── */
        function loadSavedResellerData() {
            ...
            var name = user.name || 'Reseller Partner';
            ...
            if (hdrName && name !== 'Reseller Partner') hdrName.textContent = name;
            var sideName = document.getElementById('sideUserName');
            if (sideName && name !== 'Reseller Partner') sideName.textContent = name;
            ...
            if (profName && !profName.value) profName.value = name !== 'Reseller Partner' ? name : '';
        ...
        window.loadSavedResellerData = loadSavedResellerData;
        ...
        window.handleSaveWholesalerDetails = function(e) {
            ...
            .then(function(res) {
                ...
                if (res.success) {
                    ...
                    window.showWsToast(res.message || 'Reseller Profile updated in live database!', 'success');
                } else {
        ...
        window.handleSaveResellerDetails = window.handleSaveWholesalerDetails;
            ...
            if (o.items && Array.isArray(o.items) && o.items.length > 0) {
                ...
                <div style="display:flex; gap:14px; align-items:center; background:#FFFFFF; border:1.5px solid var(--ws-border); border-radius:10px; padding:14px; margin-bottom:14px; box-shadow:0 1px 4px rgba(0,0,0,0.03);">
                    ...
                    <div style="flex:1; min-width:0;">
                        ...
                        <div style="display:flex; gap:6px; flex-wrap:wrap; margin-bottom:6px;">
                            <span style="font-size:0.72rem; font-weight:600; background:#FAF8F4; padding:2px 6px; border-radius:4px; border:1px solid var(--ws-border); color:var(--ws-text-sub);">SKU: ${o.sku || 'LOT-RS'}</span>
        ...
        window.openBillInvoiceModal = function(o) {
            ...
            var buyerName = user.name || (o.customer_name || 'Valued Reseller Partner');
            var buyerComp = user.companyName || user.company_name || user.name || 'Registered Reseller Enterprise';
        ...
        window.handleWholesalerLogout = handleWholesalerLogout;
        ...
        window.openEditMainAddressModal = openEditMainAddressModal;
        window.closeEditMainAddressModal = closeEditMainAddressModal;
        ...
        window.handleSaveMainAddressForm = function(e) {
            ...
            .then(function(res) {
                ...
                var bFullEl = document.getElementById('addrPreviewBillingFull');
                var bAttnEl = document.getElementById('addrPreviewBillingAttn');
                if (bCompEl) bCompEl.textContent = comp || (user.name || 'Registered Reseller');
                if (bFullEl) {
        ...
        window.handleSaveUserAddressForm = function(e) {
            ...
            var apiEndpoint = '/api/reseller.php';
