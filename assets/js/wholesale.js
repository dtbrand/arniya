    ...
    (function() {
        ...
        function renderAddressBookData(user) {
            user = user || {};
            var comp = user.companyName || user.company_name || user.business_name || user.name || 'Registered Account';
            ...
            var billAddr = user.address || 'Commercial Market Address';
        ...
        window.handleSaveAddress = function(e) {
            ...
            if (isDispatchVisible && !isMainVisible) {
                if (!mComp) mComp = currentUser.companyName || currentUser.company_name || currentUser.name || 'Wholesale Partner';
            ...
            if (!isSame) {
                ...
                customShipping = {
                    warehouse_name: sWarehouse || 'Primary Godown Hub',
            ...
            if (modal) {
                ...
                if (tbody) {
                    ...
                    if (!activeOrdersList || activeOrdersList.length === 0) {
                        tbody.innerHTML = '<tr><td colspan="10" style="text-align:center; padding:24px; color:#888;">No procurement records found for this account.</td></tr>';
        ...
        window.exportReportsToCsv = function() {
            ...
            link.setAttribute("download", `DT_Brands_Wholesale_Report_${new Date().toISOString().slice(0,10)}.csv`);
        ...
        window.openBillInvoiceModal = function(o) {
            ...
            if (!items.length) {
                ...
                items = [
                    {
                        name: o.productName || 'Wholesale Handloom Lot',
                        hsn: o.hsn || '5407',
                        qty: qty,
                        price: unitPrice,
                        gst: tax,
            ...
            heroContainer.innerHTML = `
                ...
                <div class="ws-track-timeline">
                    <div class="ws-timeline-step completed">
                        ...
                        <div class="ws-timeline-date">DT Brands Head Atelier, Surat • ${currentOrder.date}, 10:30 AM</div>
                    </div>
