 ...
 * Features Interactive Multi-Photo Zoom Gallery, Size/Color Selectors,
 * Pincode Delivery Estimator, WhatsApp Instant Ordering, Specifications Accordion,
 * Customer Reviews, and Related Collections Carousel.
 *
 * Includes: singelproduthader.php, singelprodutbottomfotoer.php, cart.php, wishlist.php, quickview.php
 */
...
/* ════════════════════════════════════════════════════
   LEFT COLUMN: INTERACTIVE GALLERY & MULTI-SLIDER
════════════════════════════════════════════════════ */
.pdp-gallery-column {
    display: flex;
...
.pdp-zoom-btn svg { width: 18px; height: 18px; stroke: currentColor; fill: none; stroke-width: 2.2; }
...
<main class="pdp-main-wrapper">
    <div class="pdp-layout-grid">
        ...
        <div class="pdp-gallery-column">
            <div class="pdp-main-image-box" id="pdpMainImageBox" onclick="openFullscreenImage()">
                ...
                <button class="pdp-zoom-btn" title="View Fullscreen" onclick="event.stopPropagation(); openFullscreenImage();">
            ...
            <div class="pdp-thumbnails-strip" id="pdpThumbnailsStrip">
                ...
                <div class="pdp-thumb-item <?= $index === 0 ? 'active' : '' ?>" data-src="<?= htmlspecialchars($img) ?>" onclick="switchPdpImage(this)">
        ...
        <div class="pdp-details-column">
            ...
            <div class="pdp-rating-row">
                ...
                <span class="pdp-review-count"><?= $product['reviews'] ?> Verified Buyer Reviews</span>
            ...
            <div class="pdp-price-card">
                ...
                <div class="pdp-tax-note">
                    ...
                    <span>Inclusive of all taxes • Free express shipping on this order</span>
                </div>
            </div>
...
(function() {
    ...
    // Thumbnail Switcher
    window.switchPdpImage = function(thumbEl) {
        var src = thumbEl.dataset.src;
        var mainImg = document.getElementById('pdpMainImage');
        if (mainImg && src) {
            mainImg.src = src;
        }
        document.querySelectorAll('.pdp-thumb-item').forEach(function(item) {
    ...
    window.checkPincodeDelivery = function() {
        ...
        // Realistic delivery estimate calculation
        var d = new Date();
    ...
    window.openSizeGuideModal = function() {
        window.showToast('📏 Standard Indian sizing: Sarees (5.5m + 0.8m Blouse) | Lehengas (Semi-Stitched up to 42" Waist)');
    };
