    ...
    <div class="dt-header-main" id="dtHeaderMain">
        ...
        <div class="dt-search-amazon" id="dtSearchAmazon">
            ...
            <div class="dt-search-input-wrap">
                ...
                />
                <button type="button" class="dt-search-clear" id="dtSearchClear" aria-label="Clear Search" style="display:inline-flex; align-items:center; justify-content:center;"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
