...
<head>
    ...
    <style>
        ...
        /* ═══════════════════════════════════════════════════════════════════
           SEAMLESS 3D MASTER TYPOGRAPHY FOR "WELCOME TO DT BRAND'S"
        ═══════════════════════════════════════════════════════════════════ */
        ...
        .ac-hero-showcase .ac-3d-welcome-card::after {
            display: none !important;
        }
        ...
        .ac-hero-showcase .ac-3d-corner-kicker {
            ...
            border: 1.2px solid var(--dt-gold) !important;
            ...
            box-shadow: 0 2px 6px rgba(138,104,31,0.12) !important;
        }
        .ac-hero-showcase .ac-3d-corner-kicker svg {
            color: #8A681F !important;
        }
        ...
        .ac-hero-showcase .ac-3d-welcome-line {
            ...
            display: block !important;
            text-shadow: 1px 1px 0px #FFFFFF, 2px 2px 0px rgba(212, 175, 55, 0.4) !important;
        }
        ...
        .ac-hero-showcase .ac-3d-brand-title {
            ...
            text-shadow: 
                ...
                4px 4px 0px #B8860B,
                5px 5px 0px #8A681F,
                6px 6px 1px rgba(0, 0, 0, 0.20),
                0 6px 16px rgba(138, 104, 31, 0.30) !important;
        }
        ...
        .ac-hero-showcase .ac-3d-divider-beam {
            ...
            box-shadow: 0 1px 2px rgba(0,0,0,0.12), 0 0 6px rgba(212,175,55,0.3) !important;
        }
        ...
        .ac-hero-showcase .ac-3d-crest-node {
            ...
            border: 1.2px solid #8A681F !important;
            display: flex !important;
            align-items: center !important;
            justify-content: center !important;
            box-shadow: 0 2px 6px rgba(138,104,31,0.4), inset 0 1px 0 #FFFFFF !important;
